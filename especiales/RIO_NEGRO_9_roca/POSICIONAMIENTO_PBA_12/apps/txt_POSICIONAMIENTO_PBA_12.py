from especiales.POSICIONAMIENTO_PBA_12.apps.cuestionario_POSICIONAMIENTO_PBA_12 import cuestionario

textos_POSICIONAMIENTO_PBA_12 ={
	...
	'textoDato7': 'La captura de datos se llevó a cabo del 27/06/2023 al 28/06/2023 abarcando 2.497 casos efectivos.',
...
for _,row in cuestionario.iterrows():
	...
	textos_POSICIONAMIENTO_PBA_12["pregunta" + row.codigo] = texto
	textos_POSICIONAMIENTO_PBA_12["label" + row.codigo] = label
