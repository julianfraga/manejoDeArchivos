...
path='./especiales/TRACKING_AYSA_ENTRESEMANA/'
preguntas_ocultas = []
encuesta = Encuesta('TRACKING_AYSA_ENTRESEMANA', './especiales/TRACKING_AYSA_ENTRESEMANA','cuestionario', preguntas_ocultas)
