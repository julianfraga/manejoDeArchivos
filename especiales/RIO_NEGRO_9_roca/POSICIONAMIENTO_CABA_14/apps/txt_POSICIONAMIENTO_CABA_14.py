from especiales.POSICIONAMIENTO_CABA_14.apps.cuestionario_POSICIONAMIENTO_CABA_14 import cuestionario

textos_POSICIONAMIENTO_CABA_14 ={
	...
	'textoDato7': 'La captura de datos se llevó a cabo del 27/06/2023 al 28/06/2023 abarcando 1.032 encuestas efectivas.',
...
for _,row in cuestionario.iterrows():
	...
	textos_POSICIONAMIENTO_CABA_14["pregunta" + row.codigo] = texto
	textos_POSICIONAMIENTO_CABA_14["label" + row.codigo] = label
