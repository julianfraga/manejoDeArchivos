...
textos_POSICIONAMIENTO_BA_2 ={
     'encuesta_especial': "Posicionamiento político y preferencias electorales: Elecciones PBA 2023. Abril 2023",
	...
	'textoDato6': 'Muestreo aleatorio estratificado por Cordones I, II y III de la RMBA e interior PBA. La probabilidad de selección hacia el interior de cada estrato se definió de manera proporcional al tamaño del departamento.',
	'tituloDato7': 'Tamaño muestral',
	'textoDato7': 'La captura de datos se llevó a cabo del /04/2023 al /04/2023 abarcando 3.588 casos efectivos.',
...
for _,row in cuestionario.iterrows():
	...
	textos_POSICIONAMIENTO_BA_2["pregunta" + row.codigo] = texto
	textos_POSICIONAMIENTO_BA_2["label" + row.codigo] = label
