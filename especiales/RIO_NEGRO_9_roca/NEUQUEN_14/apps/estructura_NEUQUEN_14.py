...
from especiales.NEUQUEN_14.apps.paletas_NEUQUEN_14 import paletas
from especiales.NEUQUEN_14.apps.files_NEUQUEN_14 import files_NEUQUEN_14
...
for _,row in encuesta.cuestionario[~encuesta.cuestionario.codigo.isin(encuesta.preguntas_imagenes)].iterrows():
    ...
    layout_preguntas[pregunta] = aux.get_pregunta_layout(pregunta, encuesta='NEUQUEN_14', textos=encuesta.get_textos,
                                           files=files_NEUQUEN_14, paletas=paletas, cruces_dict=cruces_dict, preguntas_ocultas=encuesta.preguntas_ocultas,
...
if encuesta.preguntas_imagenes:
    ...
    imagen = plots(files_NEUQUEN_14['csv_imagen'][0],files_NEUQUEN_14['csv_imagen'][3], files_NEUQUEN_14["Sergio Massa"][0], callbackInputTarget= 'selectTargetNEUQUEN_14',opcionesDePreguntasInicial = 4,
                                preguntasQueNoVan= encuesta.preguntas_ocultas, name='NEUQUEN_14-Comparativo',crucesDict = cruces_dict, files=files_NEUQUEN_14, codigo='NEUQUEN_14')
    ...
    layout_preguntas['imagen1'] = html.Div([
                    ...
                    getStackedBarplot(files_NEUQUEN_14['csv_imagen'][0], 'selectTargetNEUQUEN_14', 'selectOpciones_NEUQUEN_14',
                                      opinionColorDict, 'NEUQUEN_14-1D1A', opcionesDePreguntasInicial = 4), # Grafico comparado positiva
    ...
    layout_preguntas['imagen2'] = html.Div([
                    html.H3(textos_base['pregunta_imagen'], className='subtituloBloque'),
                    html.H5(textos_base['seleccioneFigura']),
                    getStackedBarplot(files_NEUQUEN_14['csv_imagen'][1], 'selectTargetNEUQUEN_14', 'selectOpciones_NEUQUEN_14',
                                      opinionColorDict, 'NEUQUEN_14-1D1B', opcionesDePreguntasInicial = 4), # Grafico compardo Negativa
                    html.H3('Seleccione un dirigente o funcionario político'),
                    imagen])
    ...
    layout_preguntas['imagen3'] = html.Div([
                    html.H3(textos_base['pregunta_imagen'], className='subtituloBloque'),
                    html.H5(textos_base['seleccioneFigura']),
                    getStackedBarplot(files_NEUQUEN_14['csv_imagen'][2], 'selectTargetNEUQUEN_14', 'selectOpciones_NEUQUEN_14',
                                      opinionColorDict, 'NEUQUEN_14-1D1C', opcionesDePreguntasInicial = 4), # Grafico comparado Ratio
                    html.H3('Seleccione un dirigente o funcionario político'),
                    imagen])