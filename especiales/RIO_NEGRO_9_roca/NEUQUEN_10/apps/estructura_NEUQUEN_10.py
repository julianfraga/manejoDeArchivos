...
from especiales.NEUQUEN_10.apps.paletas_NEUQUEN_10 import paletas
from especiales.NEUQUEN_10.apps.files_NEUQUEN_10 import files_NEUQUEN_10
...
for _,row in encuesta.cuestionario[~encuesta.cuestionario.codigo.isin(encuesta.preguntas_imagenes)].iterrows():
    ...
    layout_preguntas[pregunta] = aux.get_pregunta_layout(pregunta, encuesta='NEUQUEN_10', textos=encuesta.get_textos,
                                           files=files_NEUQUEN_10, paletas=paletas, cruces_dict=cruces_dict, preguntas_ocultas=encuesta.preguntas_ocultas,
...
if encuesta.preguntas_imagenes:
    ...
    imagen = plots(files_NEUQUEN_10['csv_imagen'][0],files_NEUQUEN_10['csv_imagen'][3], files_NEUQUEN_10["Sergio Massa"][0], callbackInputTarget= 'selectTargetNEUQUEN_10',opcionesDePreguntasInicial = 4,
                                preguntasQueNoVan= encuesta.preguntas_ocultas, name='NEUQUEN_10-Comparativo',crucesDict = cruces_dict, files=files_NEUQUEN_10, codigo='NEUQUEN_10')
    ...
    layout_preguntas['imagen1'] = html.Div([
                    ...
                    getStackedBarplot(files_NEUQUEN_10['csv_imagen'][0], 'selectTargetNEUQUEN_10', 'selectOpciones_NEUQUEN_10',
                                      opinionColorDict, 'NEUQUEN_10-1D1A', opcionesDePreguntasInicial = 4), # Grafico comparado positiva
    ...
    layout_preguntas['imagen2'] = html.Div([
                    html.H3(textos_base['pregunta_imagen'], className='subtituloBloque'),
                    html.H5(textos_base['seleccioneFigura']),
                    getStackedBarplot(files_NEUQUEN_10['csv_imagen'][1], 'selectTargetNEUQUEN_10', 'selectOpciones_NEUQUEN_10',
                                      opinionColorDict, 'NEUQUEN_10-1D1B', opcionesDePreguntasInicial = 4), # Grafico compardo Negativa
                    html.H3('Seleccione un dirigente o funcionario político'),
                    imagen])
    ...
    layout_preguntas['imagen3'] = html.Div([
                    html.H3(textos_base['pregunta_imagen'], className='subtituloBloque'),
                    html.H5(textos_base['seleccioneFigura']),
                    getStackedBarplot(files_NEUQUEN_10['csv_imagen'][2], 'selectTargetNEUQUEN_10', 'selectOpciones_NEUQUEN_10',
                                      opinionColorDict, 'NEUQUEN_10-1D1C', opcionesDePreguntasInicial = 4), # Grafico comparado Ratio
                    html.H3('Seleccione un dirigente o funcionario político'),
                    imagen])