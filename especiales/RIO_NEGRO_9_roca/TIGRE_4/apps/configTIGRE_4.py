...
from especiales.TIGRE_4.apps.preguntasTIGRE_4 import filesTIGRE_4, preguntas, preguntas_con_opciones
import pandas as pd
...
def dropdownTargetTIGRE_4(id='selectTarget', cantidadDeOpciones=20):
    opciones = opciones_TIGRE_4
    return dcc.Dropdown(
...
def dropwdownOpcionesTIGRE_4(id='selectOpciones'):
    opciones = [
...
paletas["P16"] = {
"A Segundo cernadas por Juntos": colores["cambiemos1"],
"A Gisela Zamora por el frente de todos": colores["peron1"],
"A Juan José Cervetto por avanza libertad": colores["otros"],
"A Paula Yamila Akerfeld por el Frente de Izquierda": colores["izquierda"],
"A Matias Orfo por Vamos con vos": colores["peron_nok"],
"A Nicolás Viera Dutra por el Partido Unión Celeste y Blanco": colores["otros"],
...
['La inflación', 'El desempleo', 'La corrupción', 'La inseguridad', 'El precio del dólar', 'La pobreza', 'El narcotráfico', 'Las tarifas', 'Otro', 'No sabe']
, qualitative
)
...
for pregunta, paleta in paletas.items():
    ...
    crucesDictTIGRE_4[pregunta] = [textosTIGRE_4['label' + pregunta], paleta]
