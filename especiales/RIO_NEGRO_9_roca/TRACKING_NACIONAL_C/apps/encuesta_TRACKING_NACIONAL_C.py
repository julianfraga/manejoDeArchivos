...
path='./especiales/TRACKING_NACIONAL_C/'
preguntas_ocultas = ['P16', 'P17', 'P20']
encuesta = Encuesta('TRACKING_NACIONAL_C', './especiales/TRACKING_NACIONAL_C','cuestionario', preguntas_ocultas)
