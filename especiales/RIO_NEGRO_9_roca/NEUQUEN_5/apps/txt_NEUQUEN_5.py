...
textos_NEUQUEN_5 = {
    'encuesta_especial': "Preferencias electorales: candidatos a Intendente de Cutral Có - Julio 2023",
	'bajada_encuesta_especial': "Encuesta Sincrónica",
    'bajada_encuesta_especial_fecha': "04/07/2023",
	...
	'tituloDato3': 'Ámbito',
	'textoDato3': 'Municipio de Cutral Có, Nuequén',
	...
	'textoDato7': 'La captura de datos se llevó a cabo del 29/06/2023 al 04/07/2023 abarcando 263 encuestas efectivas.',
...
for _,row in cuestionario.iterrows():
	...
	textos_NEUQUEN_5["pregunta" + row.codigo] = texto
	textos_NEUQUEN_5["label" + row.codigo] = label
