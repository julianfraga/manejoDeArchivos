...
textos_POSICIONAMIENTO_CABA_10 ={
	'encuesta_especial': "Posicionamiento politico y preferencias electorales, Elecciones presidenciales y a Gobernador. PBA Mayo 2023",
	'bajada_encuesta_especial': "Encuesta Sincrónica",
	'bajada_encuesta_especial_fecha': "12/05/2023",
	...
	'textoDato7': 'La captura de datos se llevó a cabo del 11/05/2023 al 12/05/2023 abarcando 2.655 casos efectivos.',
...
for _,row in cuestionario.iterrows():
	...
	textos_POSICIONAMIENTO_CABA_10["pregunta" + row.codigo] = texto
	textos_POSICIONAMIENTO_CABA_10["label" + row.codigo] = label
