from config import colores, votaria, opinionColorDict, list2dictPalette, siNoColorDict, ingresosColorDict, internas, diverging_mini, diverging,qualitative_strong
...
paletas["P05"] = list2dictPalette(['Si', 'No'], diverging_mini)
...
paletas["P09"] = list2dictPalette(['Si', 'No'], diverging_mini)
