...
from especiales.SAN_ISIDRO_1.apps.preguntasSAN_ISIDRO_1 import filesSAN_ISIDRO_1, preguntas, preguntas_con_opciones
import pandas as pd


opciones_SAN_ISIDRO_1 = [
...
def dropdownTargetSAN_ISIDRO_1(id='selectTarget', cantidadDeOpciones=20):
    opciones = opciones_SAN_ISIDRO_1
    return dcc.Dropdown(
...
def dropwdownOpcionesSAN_ISIDRO_1(id='selectOpciones'):
    opciones = [
...
paletas["P14"] = {
    ...
    "A Hotton por “+Valores”": colores["otros"],
    "Votaría en blanco o anularía": colores["blanco"],
}
paletas["P16"] = {
    "A Juan Aníbal Viaggo por Juntos": colores["cambiemos1"],
    "A Mateo Bartolini por el Frente de todos": colores["peron1"],
    "A Catalina Riganti por Convocación Civica por San Isidro": colores["otros"],
    "A Francisco Sicardi de Estrada por Avanza libertad": colores["liberales"],
    "A Florencia Sarmiento por el Frente de Izquierda": colores["izquierda"],
    'A Martín Eduardo Palma Bastidas por “Vamos con vos"': colores["peron_nok"],
    "Votaría en blanco o anularía": colores["blanco"],
}
paletas["P18"] = {
    ...
    "Cynthia Hotton por “+Valores”": colores["otros"],
...
crucesDictSAN_ISIDRO_1 = {}
for pregunta, paleta in paletas.items():

    crucesDictSAN_ISIDRO_1[pregunta] = [textosSAN_ISIDRO_1['label' + pregunta], paleta]
