...
path='./especiales/POSICIONAMIENTO_ESPECIAL_NACIONAL_3/'
encuesta = Encuesta('POSICIONAMIENTO_ESPECIAL_NACIONAL_3', './especiales/POSICIONAMIENTO_ESPECIAL_NACIONAL_3','cuestionario', ["P70"])
