...
textos_ALIMENTACION_1 = {
    'encuesta_especial': "Alimentación y hábitos de consumo - Mayo 2023",
	'bajada_encuesta_especial': "Encuesta Sincrónica",
    'bajada_encuesta_especial_fecha': "29/05/2023",
	...
	'textoDato7': 'La captura de datos se llevó a cabo del 22/05/2023 al 29/05/2023 abarcando 4082 casos efectivos.',
...
for _,row in cuestionario.iterrows():
	...
	textos_ALIMENTACION_1["pregunta" + row.codigo] = texto
	textos_ALIMENTACION_1["label" + row.codigo] = label
