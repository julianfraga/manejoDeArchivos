...
textos_PLOTTIER_1 = {
    'encuesta_especial': "Preferencias electorales: candidatos a Intendente de Plottier - Junio 2023",
	'bajada_encuesta_especial': "Encuesta Sincrónica",
    'bajada_encuesta_especial_fecha': "12/06/2023",
	...
	'textoDato7': 'La captura de datos se llevó a cabo del 09/06/2023 al 12/06/2023 abarcando 313 encuestas efectivas.',
...
for _,row in cuestionario.iterrows():
	...
	textos_PLOTTIER_1["pregunta" + row.codigo] = texto
	textos_PLOTTIER_1["label" + row.codigo] = label
