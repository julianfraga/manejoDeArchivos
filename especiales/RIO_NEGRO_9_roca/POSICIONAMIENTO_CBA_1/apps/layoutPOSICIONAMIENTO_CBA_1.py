from especiales.POSICIONAMIENTO_CBA_1.apps.preguntasPOSICIONAMIENTO_CBA_1 import filesPOSICIONAMIENTO_CBA_1, preguntasQueNoVanPOSICIONAMIENTO_CBA_1
...
from especiales.POSICIONAMIENTO_CBA_1.apps.bloquesPOSICIONAMIENTO_CBA_1 import bloques_POSICIONAMIENTO_CBA_1
from graphs import *
from especiales.POSICIONAMIENTO_CBA_1.apps.txtPOSICIONAMIENTO_CBA_1 import textosPOSICIONAMIENTO_CBA_1 as textos
from permisos import trackingSANTIAGOPreguntasDeshabilitadas
from graph_imagen import plots
from especiales.POSICIONAMIENTO_CBA_1.apps.preguntasPOSICIONAMIENTO_CBA_1 import imagenes

preguntas = {}
for bloque in bloques_POSICIONAMIENTO_CBA_1.values():
    for pregunta in bloque:
        preguntas[pregunta] = textosPOSICIONAMIENTO_CBA_1["label" + pregunta]

orden_preguntas = []
for _ in bloques_POSICIONAMIENTO_CBA_1.values():
...
for p in preguntas_CABA_1:
    ps[p] = html.Div([
        html.H3(textosPOSICIONAMIENTO_CBA_1['pregunta' + p], className='subtituloBloque'),
        getBarplotWithPalette(filesPOSICIONAMIENTO_CBA_1['csv' + p][0], 'selectTargetPOSICIONAMIENTO_CBA_1',
                              paletas[p], f'POSICIONAMIENTO_CBA_1-{p}-1', showticklabels=False, reverse=False),

        html.H3(textosPOSICIONAMIENTO_CBA_1['cruce'], className='subtituloBloque'),
        getCrucesStacked(filesPOSICIONAMIENTO_CBA_1['csv' + p ][2], f'POSICIONAMIENTO_CBA_1-{p}-3',
                         'selectTargetPOSICIONAMIENTO_CBA_1', '',
                         preguntasQueNoVan=preguntasQueNoVanPOSICIONAMIENTO_CBA_1, reorder=False,
                         crucesDict=crucesDictPOSICIONAMIENTO_CBA_1)
    ])
...
imagen = plots(filesPOSICIONAMIENTO_CBA_1['csv_imagen'][0],filesPOSICIONAMIENTO_CBA_1['csv_imagen'][3], filesPOSICIONAMIENTO_CBA_1["Alberto Fernandez"][0], callbackInputTarget= 'selectTargetPOSICIONAMIENTO_CBA_1',opcionesDePreguntasInicial = 4,
                            preguntasQueNoVan= preguntasQueNoVanPOSICIONAMIENTO_CBA_1, name='POSICIONAMIENTO_CBA_1-Comparativo',crucesDict = crucesDictPOSICIONAMIENTO_CBA_1, files=filesPOSICIONAMIENTO_CBA_1, tracking='POSICIONAMIENTO_CBA_1'),



ps['imagen1'] = html.Div([
                html.H3(textosPOSICIONAMIENTO_CBA_1['pregunta_imagen'], className='subtituloBloque'),
                html.H5(textosPOSICIONAMIENTO_CBA_1['seleccioneFigura']),
                getStackedBarplot(filesPOSICIONAMIENTO_CBA_1['csv_imagen'][0], 'selectTargetPOSICIONAMIENTO_CBA_1', 'selectOpciones', opinionColorDict, 'POSICIONAMIENTO_CBA_1-1D1A', opcionesDePreguntasInicial = 4),
...
ps['imagen2'] = html.Div([
                html.H3(textosPOSICIONAMIENTO_CBA_1['pregunta_imagen'], className='subtituloBloque'),
                html.H5(textosPOSICIONAMIENTO_CBA_1['seleccioneFigura']),
                getStackedBarplot(filesPOSICIONAMIENTO_CBA_1['csv_imagen'][1], 'selectTargetPOSICIONAMIENTO_CBA_1', 'selectOpciones', opinionColorDict, 'POSICIONAMIENTO_CBA_1-1D1B', opcionesDePreguntasInicial = 4),
                html.H3('Seleccione un dirigente o funcionario político'),
                imagen[0]])
...
ps['imagen3'] = html.Div([
                html.H3(textosPOSICIONAMIENTO_CBA_1['pregunta_imagen'], className='subtituloBloque'),
                html.H5(textosPOSICIONAMIENTO_CBA_1['seleccioneFigura']),
                getStackedBarplot(filesPOSICIONAMIENTO_CBA_1['csv_imagen'][2], 'selectTargetPOSICIONAMIENTO_CBA_1', 'selectOpciones', opinionColorDict, 'POSICIONAMIENTO_CBA_1-1D1C', opcionesDePreguntasInicial = 4),
                html.H3('Seleccione un dirigente o funcionario político'),
                imagen[0]])
