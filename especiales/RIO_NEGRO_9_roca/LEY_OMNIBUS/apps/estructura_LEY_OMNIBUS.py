...
from especiales.LEY_OMNIBUS.apps.paletas_LEY_OMNIBUS import paletas
from especiales.LEY_OMNIBUS.apps.files_LEY_OMNIBUS import files_LEY_OMNIBUS
...
for _,row in encuesta.cuestionario[~encuesta.cuestionario.codigo.isin(encuesta.preguntas_imagenes)].iterrows():
    ...
    layout_preguntas[pregunta] = aux.get_pregunta_layout(pregunta, encuesta='LEY_OMNIBUS', textos=encuesta.get_textos,
...
if encuesta.preguntas_imagenes:
    ...
    imagen = plots(files_LEY_OMNIBUS['csv_imagen'][0],files_LEY_OMNIBUS['csv_imagen'][3], files_LEY_OMNIBUS["Sergio Massa"][0], callbackInputTarget= 'selectTargetLEY_OMNIBUS',opcionesDePreguntasInicial = 4,
                                preguntasQueNoVan= encuesta.preguntas_ocultas, name='LEY_OMNIBUS-Comparativo',crucesDict = cruces_dict, files=files_LEY_OMNIBUS, codigo='LEY_OMNIBUS')
    ...
    layout_preguntas['imagen1'] = html.Div([
                    ...
                    getStackedBarplot(files_LEY_OMNIBUS['csv_imagen'][0], 'selectTargetLEY_OMNIBUS', 'selectOpciones_LEY_OMNIBUS',
                                      opinionColorDict, 'LEY_OMNIBUS-1D1A', opcionesDePreguntasInicial = 4), # Grafico comparado positiva
    ...
    layout_preguntas['imagen2'] = html.Div([
                    ...
                    getStackedBarplot(files_LEY_OMNIBUS['csv_imagen'][1], 'selectTargetLEY_OMNIBUS', 'selectOpciones_LEY_OMNIBUS',
                                      opinionColorDict, 'LEY_OMNIBUS-1D1B', opcionesDePreguntasInicial = 4), # Grafico compardo Negativa
                    html.H3('Seleccione un dirigente o funcionario político'),
                    imagen])
    ...
    layout_preguntas['imagen3'] = html.Div([
                    ...
                    getStackedBarplot(files_LEY_OMNIBUS['csv_imagen'][2], 'selectTargetLEY_OMNIBUS', 'selectOpciones_LEY_OMNIBUS',
                                      opinionColorDict, 'LEY_OMNIBUS-1D1C', opcionesDePreguntasInicial = 4), # Grafico comparado Ratio
                    html.H3('Seleccione un dirigente o funcionario político'),
                    imagen])