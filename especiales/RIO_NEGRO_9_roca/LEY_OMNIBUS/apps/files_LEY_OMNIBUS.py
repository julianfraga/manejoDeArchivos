from especiales.LEY_OMNIBUS.apps.encuesta_LEY_OMNIBUS import encuesta, path, opciones
...
# { 'Sergio Massa': ['./especiales/LEY_OMNIBUS/data/cruce_pregunta_P61_4opc.csv',
#                   './especiales/LEY_OMNIBUS/data/cruce_pregunta_P61_6opc.csv'], ...
