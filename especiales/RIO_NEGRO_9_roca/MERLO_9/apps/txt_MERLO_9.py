...
textos_MERLO_9 = {
    'encuesta_especial': "Encuesta Electoral Merlo - Mayo 2023",
	'bajada_encuesta_especial': "Encuesta Sincrónica",
    'bajada_encuesta_especial_fecha': "21/05/2023",
	...
	'textoDato7': 'La captura de datos se llevó a cabo del 16/05/2023 al 21/05/2023 abarcando 483 casos efectivos.',
...
for _,row in cuestionario.iterrows():
	...
	textos_MERLO_9["pregunta" + row.codigo] = texto
	textos_MERLO_9["label" + row.codigo] = label
