...
path='./especiales/TRACKING_NACIONAL_ENTRESEMANA/'
preguntas_ocultas = ['P10']
encuesta = Encuesta('TRACKING_NACIONAL_ENTRESEMANA', './especiales/TRACKING_NACIONAL_ENTRESEMANA','cuestionario', preguntas_ocultas)
