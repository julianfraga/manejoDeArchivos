...
from especiales.TIGRE_15.apps.paletas_TIGRE_15 import paletas
from especiales.TIGRE_15.apps.files_TIGRE_15 import files_TIGRE_15
...
for _,row in encuesta.cuestionario[~encuesta.cuestionario.codigo.isin(encuesta.preguntas_imagenes)].iterrows():
    ...
    layout_preguntas[pregunta] = aux.get_pregunta_layout(pregunta, encuesta='TIGRE_15', textos=encuesta.get_textos,
                                           files=files_TIGRE_15, paletas=paletas, cruces_dict=cruces_dict, preguntas_ocultas=encuesta.preguntas_ocultas,
...
if encuesta.preguntas_imagenes:
    ...
    imagen = plots(files_TIGRE_15['csv_imagen'][0],files_TIGRE_15['csv_imagen'][3], files_TIGRE_15["Sergio Massa"][0], callbackInputTarget= 'selectTargetTIGRE_15',opcionesDePreguntasInicial = 4,
                                preguntasQueNoVan= encuesta.preguntas_ocultas, name='TIGRE_15-Comparativo',crucesDict = cruces_dict, files=files_TIGRE_15, codigo='TIGRE_15')
    ...
    layout_preguntas['imagen1'] = html.Div([
                    ...
                    getStackedBarplot(files_TIGRE_15['csv_imagen'][0], 'selectTargetTIGRE_15', 'selectOpciones_TIGRE_15',
                                      opinionColorDict, 'TIGRE_15-1D1A', opcionesDePreguntasInicial = 4), # Grafico comparado positiva
    ...
    layout_preguntas['imagen2'] = html.Div([
                    html.H3(textos_base['pregunta_imagen'], className='subtituloBloque'),
                    html.H5(textos_base['seleccioneFigura']),
                    getStackedBarplot(files_TIGRE_15['csv_imagen'][1], 'selectTargetTIGRE_15', 'selectOpciones_TIGRE_15',
                                      opinionColorDict, 'TIGRE_15-1D1B', opcionesDePreguntasInicial = 4), # Grafico compardo Negativa
                    html.H3('Seleccione un dirigente o funcionario político'),
                    imagen])
    ...
    layout_preguntas['imagen3'] = html.Div([
                    html.H3(textos_base['pregunta_imagen'], className='subtituloBloque'),
                    html.H5(textos_base['seleccioneFigura']),
                    getStackedBarplot(files_TIGRE_15['csv_imagen'][2], 'selectTargetTIGRE_15', 'selectOpciones_TIGRE_15',
                                      opinionColorDict, 'TIGRE_15-1D1C', opcionesDePreguntasInicial = 4), # Grafico comparado Ratio
                    html.H3('Seleccione un dirigente o funcionario político'),
                    imagen])