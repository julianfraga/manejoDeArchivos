...
path='./especiales/TIGRE_15/'

preguntas_ocultas = ['CORTA_INTENDENTE', 'CORTA_PRESIDENTE', 'P16', 'P17', 'P20', "P23"]
encuesta = Encuesta('TIGRE_15', './especiales/TIGRE_15','cuestionario', preguntas_ocultas=preguntas_ocultas)
