...
from especiales.TIGRE_5.apps.preguntasTIGRE_5 import filesTIGRE_5, preguntas, preguntas_con_opciones
import pandas as pd
...
def dropdownTargetTIGRE_5(id='selectTarget', cantidadDeOpciones=20):
    opciones = opciones_TIGRE_5
    return dcc.Dropdown(
...
def dropwdownOpcionesTIGRE_5(id='selectOpciones'):
    opciones = [
...
for pregunta, paleta in paletas.items():
    ...
    crucesDictTIGRE_5[pregunta] = [textosTIGRE_5['label' + pregunta], paleta]
