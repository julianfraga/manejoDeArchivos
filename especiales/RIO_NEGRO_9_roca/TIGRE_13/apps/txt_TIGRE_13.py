...
textos_TIGRE_13 = {
    'encuesta_especial': "Preferencias electorales. Municipio de Tigre, corte 13 - Junio 2023",
	...
	'textoDato7': 'La captura de datos se llevó a cabo el 24/06/2023 abarcando 810 encuestas efectivas.',
...
for _,row in cuestionario.iterrows():
	...
	textos_TIGRE_13["pregunta" + row.codigo] = texto
	textos_TIGRE_13["label" + row.codigo] = label
