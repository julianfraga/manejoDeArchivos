...
path='./especiales/POSICIONAMIENTO_ESPECIAL_CABA/'
...
encuesta = Encuesta('POSICIONAMIENTO_ESPECIAL_CABA', './especiales/POSICIONAMIENTO_ESPECIAL_CABA','cuestionario', preguntas_ocultas)
