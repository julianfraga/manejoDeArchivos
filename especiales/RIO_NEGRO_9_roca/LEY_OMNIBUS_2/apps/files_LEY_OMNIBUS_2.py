from especiales.LEY_OMNIBUS_2.apps.encuesta_LEY_OMNIBUS_2 import encuesta, path, opciones
...
# { 'Sergio Massa': ['./especiales/LEY_OMNIBUS_2/data/cruce_pregunta_P61_4opc.csv',
#                   './especiales/LEY_OMNIBUS_2/data/cruce_pregunta_P61_6opc.csv'], ...
