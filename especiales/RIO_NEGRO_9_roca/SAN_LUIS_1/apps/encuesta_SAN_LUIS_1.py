...
path='./especiales/SAN_LUIS_1/'
preguntas_ocultas = []
encuesta = Encuesta('SAN_LUIS_1', './especiales/SAN_LUIS_1','cuestionario', preguntas_ocultas)
...
opciones_target = [
        ...
        {'label': 'Región: San Luis Capital', 'value': 'San Luis'},
        {'label': 'Región: Villa Mercedes', 'value': 'Villa Mercedes'},
        {'label': 'Región: Otras localidades de la Pcia.', 'value': 'Otra localidad'},
                                     ]
