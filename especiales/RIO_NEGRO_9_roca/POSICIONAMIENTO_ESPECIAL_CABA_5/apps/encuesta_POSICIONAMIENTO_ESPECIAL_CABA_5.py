...
path='./especiales/POSICIONAMIENTO_ESPECIAL_CABA_5/'
preguntas_ocultas = []
encuesta = Encuesta('POSICIONAMIENTO_ESPECIAL_CABA_5', './especiales/POSICIONAMIENTO_ESPECIAL_CABA_5','cuestionario', preguntas_ocultas)
