...
from especiales.TIGRE_8.apps.preguntasTIGRE_8 import filesTIGRE_8, preguntas, preguntas_con_opciones
import pandas as pd
...
def dropdownTargetTIGRE_8(id='selectTarget', cantidadDeOpciones=20):
    opciones = opciones_TIGRE_8
    return dcc.Dropdown(
...
def dropwdownOpcionesTIGRE_8(id='selectOpcionesTIGRE_8'):
    opciones = [
...
paletas['P30']  = list2dictPalette(['Seguro lo votaria', 'Quizás lo votaría', 'Nunca lo votaría'], diverging, noSabe=False)
...
for pregunta, paleta in paletas.items():
    ...
    crucesDictTIGRE_8[pregunta] = [textosTIGRE_8['label' + pregunta], paleta]
