import pandas as pd
import aux
from especiales.PPERON_3.apps.paletas_PPERON_3 import paletas
from especiales.PPERON_3.apps.cuestionario_PPERON_3 import *
from especiales.PPERON_3.apps.txt_PPERON_3 import textos_PPERON_3
from especiales.PPERON_3.apps.files_PPERON_3 import files_PPERON_3
...
for pregunta, paleta in paletas.items():
    if pregunta not in preguntas_ocultas:
        cruces_dict[pregunta] = [textos_PPERON_3 ['label' + pregunta], paleta]
...
for _,row in cuestionario[~cuestionario.codigo.isin(preguntas_imagenes)].iterrows():
        ...
        if pregunta not in preguntas_ocultas:
            ...
            ps[pregunta] = aux.get_pregunta_layout(pregunta, encuesta='PPERON_3', textos=textos_PPERON_3,
                                                   files=files_PPERON_3, paletas=paletas, cruces_dict=cruces_dict,preguntas_ocultas=preguntas_ocultas,
                                                   opciones=tiene_opciones)


def dropdownTarget(id='selectTargetPPERON_3', cantidadDeOpciones=17):
    opciones = [
        ...
        {'label': 'Voto 2019: Blanca Cantero', 'value': 'Cantero'},
        {'label': 'Voto 2019: Guido Giana', 'value': 'Giana'},
        {'label': 'Voto 2019: Manuel Toffanelli', 'value': 'Toffanelli'},
        {'label': 'Voto 2019: Malco Müller', 'value': 'Muller'},
        {'label': 'Voto 2019: Marcelo Gómez', 'value': 'Gomez'},
        {'label': 'Voto 2019: Víctor Rengifo', 'value': 'Rengifo'},
        ]
...
def plot_cruces(candidato,df_cruces,files, name, preguntasQueNoVan, callbackInputTarget, crucesDict = crucesDict,opcionesDePreguntasInicial='', reorder=True):
    ...
    @app.callback(
        ...
        [Input('selectCruce' + name + candidato, 'value'),
         ...
         Input("selectOpciones_PPERON_3", 'value'), ])
...
def plots(csv_hbp,csv_ts, csv_cruces, callbackInputTarget = '', crucesDict = crucesDict, opcionesDePreguntasInicial = 4, preguntasQueNoVan = "", preguntasDeshabilitadas = '', name = '', tracking='Nacional', files=''):
    ...
    for candidato in candidatos:
        ...
        hbarplot  = plot_hbarplot(csv_hbp, df_hbp, candidato, callbackInputTarget, 'selectOpciones_PPERON_3', opinionColorDict, name, opcionesDePreguntasInicial = opcionesDePreguntasInicial)
...
# imagen = plots(files_PPERON_3['csv_imagen'][0],files_PPERON_3['csv_imagen'][3], files_PPERON_3['Alberto Fernández'][0], callbackInputTarget= 'selectTargetPPERON_3',opcionesDePreguntasInicial = 4,
#                           preguntasQueNoVan= preguntas_ocultas, name='PPERON_3-Comparativo',crucesDict = cruces_dict, files=files_PPERON_3, tracking='PPERON_3'),
# ps['imagen1'] = html.Div([
#                html.H3(textos['pregunta_imagen'], className='subtituloBloque'),
#                html.H5(textos['seleccioneFigura']),
#                getStackedBarplot(files_PPERON_3['csv_imagen'][0], 'selectTargetPPERON_3', 'selectOpciones_PPERON_3', opinionColorDict, 'PPERON_3-1D1A', opcionesDePreguntasInicial = 4),
...
#                html.H3(textos['pregunta_imagen'], className='subtituloBloque'),
#                html.H5(textos['seleccioneFigura']),
#                getStackedBarplot(files_PPERON_3['csv_imagen'][1], 'selectTargetPPERON_3', 'selectOpciones_PPERON_3', opinionColorDict, 'PPERON_3-1D1B', opcionesDePreguntasInicial = 4),
#                html.H3('Seleccione un dirigente o funcionario político'),
#                imagen[0]])
...
#                html.H3(textos['pregunta_imagen'], className='subtituloBloque'),
#                html.H5(textos['seleccioneFigura']),
#                getStackedBarplot(files_PPERON_3['csv_imagen'][2], 'selectTargetPPERON_3', 'selectOpciones_PPERON_3', opinionColorDict, 'PPERON_3-1D1C', opcionesDePreguntasInicial = 4),
#                html.H3('Seleccione un dirigente o funcionario político'),
#                imagen[0]])
