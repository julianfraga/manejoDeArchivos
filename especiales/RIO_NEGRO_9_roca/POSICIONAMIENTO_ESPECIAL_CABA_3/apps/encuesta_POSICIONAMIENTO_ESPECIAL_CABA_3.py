...
path='./especiales/POSICIONAMIENTO_ESPECIAL_CABA_3/'
encuesta = Encuesta('POSICIONAMIENTO_ESPECIAL_CABA_3', './especiales/POSICIONAMIENTO_ESPECIAL_CABA_3','cuestionario', ["P70"])
