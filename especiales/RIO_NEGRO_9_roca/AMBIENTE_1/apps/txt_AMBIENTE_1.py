...
textos_AMBIENTE_1 ={
	'encuesta_especial': "Medio Ambiente - Mayo 2023",
	'bajada_encuesta_especial': "Encuesta Sincrónica",
	'bajada_encuesta_especial_fecha': "15/05/2023",
	...
	'textoDato7': 'La captura de datos se llevó a cabo del ../05/2023 al ../05/2023 abarcando 1.844 casos efectivos.',
...
for _,row in cuestionario.iterrows():
	...
	textos_AMBIENTE_1["pregunta" + row.codigo] = texto
	textos_AMBIENTE_1["label" + row.codigo] = label
