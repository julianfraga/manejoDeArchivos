...
from especiales.MERLO_11.apps.paletas_MERLO_11 import paletas
from especiales.MERLO_11.apps.files_MERLO_11 import files_MERLO_11
...
for _,row in encuesta.cuestionario[~encuesta.cuestionario.codigo.isin(encuesta.preguntas_imagenes)].iterrows():
    ...
    layout_preguntas[pregunta] = aux.get_pregunta_layout(pregunta, encuesta='MERLO_11', textos=encuesta.get_textos,
                                           files=files_MERLO_11, paletas=paletas, cruces_dict=cruces_dict, preguntas_ocultas=encuesta.preguntas_ocultas,
...
if encuesta.preguntas_imagenes:
    ...
    imagen = plots(files_MERLO_11['csv_imagen'][0],files_MERLO_11['csv_imagen'][3], files_MERLO_11["Sergio Massa"][0], callbackInputTarget= 'selectTargetMERLO_11',opcionesDePreguntasInicial = 4,
                                preguntasQueNoVan= encuesta.preguntas_ocultas, name='MERLO_11-Comparativo',crucesDict = cruces_dict, files=files_MERLO_11, codigo='MERLO_11')
    ...
    layout_preguntas['imagen1'] = html.Div([
                    ...
                    getStackedBarplot(files_MERLO_11['csv_imagen'][0], 'selectTargetMERLO_11', 'selectOpciones_MERLO_11',
                                      opinionColorDict, 'MERLO_11-1D1A', opcionesDePreguntasInicial = 4), # Grafico comparado positiva
    ...
    layout_preguntas['imagen2'] = html.Div([
                    html.H3(textos_base['pregunta_imagen'], className='subtituloBloque'),
                    html.H5(textos_base['seleccioneFigura']),
                    getStackedBarplot(files_MERLO_11['csv_imagen'][1], 'selectTargetMERLO_11', 'selectOpciones_MERLO_11',
                                      opinionColorDict, 'MERLO_11-1D1B', opcionesDePreguntasInicial = 4), # Grafico compardo Negativa
                    html.H3('Seleccione un dirigente o funcionario político'),
                    imagen])
    ...
    layout_preguntas['imagen3'] = html.Div([
                    html.H3(textos_base['pregunta_imagen'], className='subtituloBloque'),
                    html.H5(textos_base['seleccioneFigura']),
                    getStackedBarplot(files_MERLO_11['csv_imagen'][2], 'selectTargetMERLO_11', 'selectOpciones_MERLO_11',
                                      opinionColorDict, 'MERLO_11-1D1C', opcionesDePreguntasInicial = 4), # Grafico comparado Ratio
                    html.H3('Seleccione un dirigente o funcionario político'),
                    imagen])