...
textos_POSICIONAMIENTO_ESPECIAL_PBA_2 ={
	'encuesta_especial': "Posicionamiento politico y preferencias electorales. Elecciones presidenciales y a Gobernador. PBA Julio 2023",
	'bajada_encuesta_especial': "Encuesta Sincrónica",
	'bajada_encuesta_especial_fecha': "14/07/2023",
	...
	'textoDato7': 'La captura de datos se llevó a cabo del 13/07/2023 al 14/07/2023 abarcando 3.240 casos efectivos.',
...
for _,row in cuestionario.iterrows():
	...
	textos_POSICIONAMIENTO_ESPECIAL_PBA_2["pregunta" + row.codigo] = texto
	textos_POSICIONAMIENTO_ESPECIAL_PBA_2["label" + row.codigo] = label
