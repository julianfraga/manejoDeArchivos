...
path='./especiales/POSICIONAMIENTO_ESPECIAL_NACIONAL_5/'
encuesta = Encuesta('POSICIONAMIENTO_ESPECIAL_NACIONAL_5', './especiales/POSICIONAMIENTO_ESPECIAL_NACIONAL_5','cuestionario', ["P70"])
