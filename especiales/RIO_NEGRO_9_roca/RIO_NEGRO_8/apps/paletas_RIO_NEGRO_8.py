from config import colores, ingresosColorDict, opinionColorDict, list2dictPalette, siNoColorDict, acuerdoBisColorDict, diverging,qualitative_strong,diverging_reverse
