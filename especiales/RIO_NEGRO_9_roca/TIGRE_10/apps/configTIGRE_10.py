...
from especiales.TIGRE_10.apps.preguntasTIGRE_10 import filesTIGRE_10, preguntas, preguntas_con_opciones
import pandas as pd
...
def dropdownTargetTIGRE_10(id='selectTarget', cantidadDeOpciones=20):
    opciones = opciones_TIGRE_10
    return dcc.Dropdown(
...
def dropwdownOpcionesTIGRE_10(id='selectOpcionesTIGRE_10'):
    opciones = [
...
for pregunta, paleta in paletas.items():
    ...
    crucesDictTIGRE_10[pregunta] = [textosTIGRE_10['label' + pregunta], paleta]
