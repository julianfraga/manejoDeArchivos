import pandas as pd
import aux
from especiales.RIO_NEGRO_1.apps.paletas_RIO_NEGRO_1 import paletas
from especiales.RIO_NEGRO_1.apps.cuestionario_RIO_NEGRO_1 import *
from especiales.RIO_NEGRO_1.apps.txt_RIO_NEGRO_1 import textos_RIO_NEGRO_1
from especiales.RIO_NEGRO_1.apps.files_RIO_NEGRO_1 import files_RIO_NEGRO_1
...
for pregunta, paleta in paletas.items():
    if pregunta not in preguntas_ocultas:
        cruces_dict[pregunta] = [textos_RIO_NEGRO_1 ['label' + pregunta], paleta]
...
for _,row in cuestionario[~cuestionario.codigo.isin(preguntas_imagenes)].iterrows():
        ...
        if pregunta not in preguntas_ocultas:
            ...
            ps[pregunta] = aux.get_pregunta_layout(pregunta, encuesta='RIO_NEGRO_1', textos=textos_RIO_NEGRO_1,
                                                   files=files_RIO_NEGRO_1, paletas=paletas, cruces_dict=cruces_dict,preguntas_ocultas=preguntas_ocultas,
                                                   opciones=tiene_opciones)


def dropdownTarget(id='selectTargetRIO_NEGRO_1', cantidadDeOpciones=17):
    opciones = [
        ...
        {'label': 'Voto Abril 2023: Weretilneck y Pesatti', 'value': 'Weretilneck/Pesatti'},
        {'label': 'Voto Abril 2023: Tortoriello y Álvarez Guerrero', 'value': 'Tortoriello/Álvarez Guerrero'},
        {'label': 'Voto Abril 2023: Horne y Costa Brutten', 'value': 'Horne/Costa Brutten'},
        {'label': 'Voto Abril 2023: Rivero y Astuena', 'value': 'Rivero/Astuena'},
        {'label': 'Voto Abril 2023: Casas y Villarroel', 'value': 'Casas/Villarroel'},
        {'label': 'Voto Abril 2023: Zamaro y Roca', 'value': 'Zamaro/Roca'},
        ]
...
def plot_cruces(candidato,df_cruces,files, name, preguntasQueNoVan, callbackInputTarget, crucesDict = crucesDict,opcionesDePreguntasInicial='', reorder=True):
    ...
    @app.callback(
        ...
        [Input('selectCruce' + name + candidato, 'value'),
         ...
         Input("selectOpciones_RIO_NEGRO_1", 'value'), ])
...
def plots(csv_hbp,csv_ts, csv_cruces, callbackInputTarget = '', crucesDict = crucesDict, opcionesDePreguntasInicial = 4, preguntasQueNoVan = "", preguntasDeshabilitadas = '', name = '', tracking='Nacional', files=''):
    ...
    for candidato in candidatos:
        ...
        hbarplot  = plot_hbarplot(csv_hbp, df_hbp, candidato, callbackInputTarget, 'selectOpciones_RIO_NEGRO_1', opinionColorDict, name, opcionesDePreguntasInicial = opcionesDePreguntasInicial)
...
# imagen = plots(files_RIO_NEGRO_1['csv_imagen'][0],files_RIO_NEGRO_1['csv_imagen'][3], files_RIO_NEGRO_1['Alberto Fernández'][0], callbackInputTarget= 'selectTargetRIO_NEGRO_1',opcionesDePreguntasInicial = 4,
#                           preguntasQueNoVan= preguntas_ocultas, name='RIO_NEGRO_1-Comparativo',crucesDict = cruces_dict, files=files_RIO_NEGRO_1, tracking='RIO_NEGRO_1'),
# ps['imagen1'] = html.Div([
#                html.H3(textos['pregunta_imagen'], className='subtituloBloque'),
#                html.H5(textos['seleccioneFigura']),
#                getStackedBarplot(files_RIO_NEGRO_1['csv_imagen'][0], 'selectTargetRIO_NEGRO_1', 'selectOpciones_RIO_NEGRO_1', opinionColorDict, 'RIO_NEGRO_1-1D1A', opcionesDePreguntasInicial = 4),
...
#                html.H3(textos['pregunta_imagen'], className='subtituloBloque'),
#                html.H5(textos['seleccioneFigura']),
#                getStackedBarplot(files_RIO_NEGRO_1['csv_imagen'][1], 'selectTargetRIO_NEGRO_1', 'selectOpciones_RIO_NEGRO_1', opinionColorDict, 'RIO_NEGRO_1-1D1B', opcionesDePreguntasInicial = 4),
#                html.H3('Seleccione un dirigente o funcionario político'),
#                imagen[0]])
...
#                html.H3(textos['pregunta_imagen'], className='subtituloBloque'),
#                html.H5(textos['seleccioneFigura']),
#                getStackedBarplot(files_RIO_NEGRO_1['csv_imagen'][2], 'selectTargetRIO_NEGRO_1', 'selectOpciones_RIO_NEGRO_1', opinionColorDict, 'RIO_NEGRO_1-1D1C', opcionesDePreguntasInicial = 4),
#                html.H3('Seleccione un dirigente o funcionario político'),
#                imagen[0]])
