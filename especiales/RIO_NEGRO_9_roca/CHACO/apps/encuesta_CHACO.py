...
path='./especiales/CHACO/'
preguntas_ocultas = []
encuesta = Encuesta('CHACO', './especiales/CHACO','cuestionario', preguntas_ocultas)
...
opciones_target = [
        ...
        {'label' : 'Voto Gobernador PASO 2023: J. Capitanich', 'value' : 'Capitanich'},
        {'label' : 'Voto Gobernador PASO 2023: I. Espinoza', 'value' : 'Espinoza'},
        {'label' : 'Voto Gobernador PASO 2023: L. Zdero', 'value' : 'Zdero'},
        {'label' : 'Voto Gobernador PASO 2023: J. C. Polini', 'value' : 'Polini'},
        {'label' : 'Voto Gobernador PASO 2023: G. Martinez', 'value' : 'Martinez'},
        {'label' : 'Voto Gobernador PASO 2023: A. Rodriguez', 'value' : 'Rodriguez'},

        {'label': 'Región: Resistencia', 'value': 'Resistencia'},
