from especiales.ALQUILERES_NACIONAL_1.apps.cuestionario_ALQUILERES_NACIONAL_1 import cuestionario, path, opciones

files_ALQUILERES_NACIONAL_1 = {}
data_folder = path + "data/"

for pregunta in cuestionario.query('bloque != "imagen"').codigo:
    files_ALQUILERES_NACIONAL_1["csv" + pregunta] = [('{}pregunta_' + pregunta + '.csv').format(data_folder),
...
for _, row in cuestionario.query('paleta == "imagen"').iterrows():
    ...
    files_ALQUILERES_NACIONAL_1[figura] = ['{}cruce_pregunta_{}{}.csv'.format(data_folder, row.codigo, opcion)
