...
from especiales.MERLO_12.apps.paletas_MERLO_12 import paletas
from especiales.MERLO_12.apps.files_MERLO_12 import files_MERLO_12
...
for _,row in encuesta.cuestionario[~encuesta.cuestionario.codigo.isin(encuesta.preguntas_imagenes)].iterrows():
    ...
    layout_preguntas[pregunta] = aux.get_pregunta_layout(pregunta, encuesta='MERLO_12', textos=encuesta.get_textos,
                                           files=files_MERLO_12, paletas=paletas, cruces_dict=cruces_dict, preguntas_ocultas=encuesta.preguntas_ocultas,
...
if encuesta.preguntas_imagenes:
    ...
    imagen = plots(files_MERLO_12['csv_imagen'][0],files_MERLO_12['csv_imagen'][3], files_MERLO_12["Sergio Massa"][0], callbackInputTarget= 'selectTargetMERLO_12',opcionesDePreguntasInicial = 4,
                                preguntasQueNoVan= encuesta.preguntas_ocultas, name='MERLO_12-Comparativo',crucesDict = cruces_dict, files=files_MERLO_12, codigo='MERLO_12')
    ...
    layout_preguntas['imagen1'] = html.Div([
                    ...
                    getStackedBarplot(files_MERLO_12['csv_imagen'][0], 'selectTargetMERLO_12', 'selectOpciones_MERLO_12',
                                      opinionColorDict, 'MERLO_12-1D1A', opcionesDePreguntasInicial = 4), # Grafico comparado positiva
    ...
    layout_preguntas['imagen2'] = html.Div([
                    html.H3(textos_base['pregunta_imagen'], className='subtituloBloque'),
                    html.H5(textos_base['seleccioneFigura']),
                    getStackedBarplot(files_MERLO_12['csv_imagen'][1], 'selectTargetMERLO_12', 'selectOpciones_MERLO_12',
                                      opinionColorDict, 'MERLO_12-1D1B', opcionesDePreguntasInicial = 4), # Grafico compardo Negativa
                    html.H3('Seleccione un dirigente o funcionario político'),
                    imagen])
    ...
    layout_preguntas['imagen3'] = html.Div([
                    html.H3(textos_base['pregunta_imagen'], className='subtituloBloque'),
                    html.H5(textos_base['seleccioneFigura']),
                    getStackedBarplot(files_MERLO_12['csv_imagen'][2], 'selectTargetMERLO_12', 'selectOpciones_MERLO_12',
                                      opinionColorDict, 'MERLO_12-1D1C', opcionesDePreguntasInicial = 4), # Grafico comparado Ratio
                    html.H3('Seleccione un dirigente o funcionario político'),
                    imagen])