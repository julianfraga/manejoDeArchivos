...
path='./especiales/POSICIONAMIENTO_ESPECIAL_PBA_6/'
preguntas_ocultas = ['P13', 'P18', 'P21', 'P32', 'P33', 'P34', 'P35', 'P36', 'P37', 'P38', 'P39', 'P45', 'P46', 'P47', 'P48', 'P49', 'P50', 'P51', 'P52','PRESIDENTE','CORTA_GOBERNADOR','CORTA_PRESIDENTE','GOBERNADOR']

encuesta = Encuesta('POSICIONAMIENTO_ESPECIAL_PBA_6', './especiales/POSICIONAMIENTO_ESPECIAL_PBA_6','cuestionario', preguntas_ocultas)
