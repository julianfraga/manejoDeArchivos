...
encuesta = Encuesta('NEUQUEN_6', './especiales/NEUQUEN_6','cuestionario', preguntas_ocultas)
...
n_opciones_target = 1#len(opciones_target) # Cambiar de ser neceario, habria que deprecarlo
