...
textos_NEUQUEN_2 ={
    'encuesta_especial': "Preferencias electorales: Elecciones gobernador 2023 Neuquén. Abril 2023",
	'bajada_encuesta_especial': "Encuesta Sincrónica",
    'bajada_encuesta_especial_fecha': "14/04/2023",
	...
	'textoDato7': 'La captura de datos se llevó a cabo del 11/04/2023 al 12/04/2023 abarcando 1.105 casos efectivos.',
...
for _,row in cuestionario.iterrows():
	...
	if aclaracion  and not aclaracion.startswith('('):
		...
		sep= ", "
	texto = f'{row.texto} {aclaracion}'.strip()
	label = f'{row.label}{sep}{aclaracion}'.strip()


	textos_NEUQUEN_2["pregunta" + row.codigo] = texto
	textos_NEUQUEN_2["label" + row.codigo] = label
