from especiales.POSICIONAMIENTO_NACIONAL_12.apps.cuestionario_POSICIONAMIENTO_NACIONAL_12 import cuestionario

textos_POSICIONAMIENTO_NACIONAL_12 ={
	'encuesta_especial': "Posicionamiento politico y preferencias electorales, Elecciones presidenciales. Junio 2023",
	...
	'textoDato7': 'La captura de datos se llevó a cabo del 27/06/2023 al 28/06/2023 abarcando 5.285 casos efectivos.',
...
for _,row in cuestionario.iterrows():
	...
	textos_POSICIONAMIENTO_NACIONAL_12["pregunta" + row.codigo] = texto
	textos_POSICIONAMIENTO_NACIONAL_12["label" + row.codigo] = label
