...
path='./especiales/POSICIONAMIENTO_ESPECIAL_PBA_3/'
encuesta = Encuesta('POSICIONAMIENTO_ESPECIAL_PBA_3', './especiales/POSICIONAMIENTO_ESPECIAL_PBA_3','cuestionario', ["P70"])
