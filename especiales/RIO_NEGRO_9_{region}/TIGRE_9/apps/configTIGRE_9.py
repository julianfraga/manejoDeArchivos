...
from especiales.TIGRE_9.apps.preguntasTIGRE_9 import filesTIGRE_9, preguntas, preguntas_con_opciones
import pandas as pd
...
def dropdownTargetTIGRE_9(id='selectTarget', cantidadDeOpciones=20):
    opciones = opciones_TIGRE_9
    return dcc.Dropdown(
...
def dropwdownOpcionesTIGRE_9(id='selectOpcionesTIGRE_9'):
    opciones = [
...
for pregunta, paleta in paletas.items():
    ...
    crucesDictTIGRE_9[pregunta] = [textosTIGRE_9['label' + pregunta], paleta]
