from especiales.POSICIONAMIENTO_PBA_9.apps.cuestionario_POSICIONAMIENTO_PBA_9 import cuestionario

textos_POSICIONAMIENTO_PBA_9 ={
     'encuesta_especial': "Posicionamiento político y preferencias electorales: Elecciones presidenciales 2023 PBA. Abril 2023",
	...
	'textoDato7': 'La captura de datos se llevó a cabo del /04/2023 al /04/2023 abarcando 11.461 casos efectivos.',
...
for _,row in cuestionario.iterrows():
	...
	textos_POSICIONAMIENTO_PBA_9["pregunta" + row.codigo] = texto
	textos_POSICIONAMIENTO_PBA_9["label" + row.codigo] = label
