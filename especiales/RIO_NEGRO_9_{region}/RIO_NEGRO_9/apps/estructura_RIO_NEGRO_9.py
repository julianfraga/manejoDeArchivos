...
from especiales.RIO_NEGRO_9.apps.paletas_RIO_NEGRO_9 import paletas
from especiales.RIO_NEGRO_9.apps.files_RIO_NEGRO_9 import files_RIO_NEGRO_9
...
for _,row in encuesta.cuestionario[~encuesta.cuestionario.codigo.isin(encuesta.preguntas_imagenes)].iterrows():
    ...
    layout_preguntas[pregunta] = aux.get_pregunta_layout(pregunta, encuesta='RIO_NEGRO_9', textos=encuesta.get_textos,
                                           files=files_RIO_NEGRO_9, paletas=paletas, cruces_dict=cruces_dict, preguntas_ocultas=encuesta.preguntas_ocultas,
...
if encuesta.preguntas_imagenes:
    ...
    imagen = plots(files_RIO_NEGRO_9['csv_imagen'][0],files_RIO_NEGRO_9['csv_imagen'][3], files_RIO_NEGRO_9["Sergio Massa"][0], callbackInputTarget= 'selectTargetRIO_NEGRO_9',opcionesDePreguntasInicial = 4,
                                preguntasQueNoVan= encuesta.preguntas_ocultas, name='RIO_NEGRO_9-Comparativo',crucesDict = cruces_dict, files=files_RIO_NEGRO_9, codigo='RIO_NEGRO_9')
    ...
    layout_preguntas['imagen1'] = html.Div([
                    ...
                    getStackedBarplot(files_RIO_NEGRO_9['csv_imagen'][0], 'selectTargetRIO_NEGRO_9', 'selectOpciones_RIO_NEGRO_9',
                                      opinionColorDict, 'RIO_NEGRO_9-1D1A', opcionesDePreguntasInicial = 4), # Grafico comparado positiva
    ...
    layout_preguntas['imagen2'] = html.Div([
                    html.H3(textos_base['pregunta_imagen'], className='subtituloBloque'),
                    html.H5(textos_base['seleccioneFigura']),
                    getStackedBarplot(files_RIO_NEGRO_9['csv_imagen'][1], 'selectTargetRIO_NEGRO_9', 'selectOpciones_RIO_NEGRO_9',
                                      opinionColorDict, 'RIO_NEGRO_9-1D1B', opcionesDePreguntasInicial = 4), # Grafico compardo Negativa
                    html.H3('Seleccione un dirigente o funcionario político'),
                    imagen])
    ...
    layout_preguntas['imagen3'] = html.Div([
                    html.H3(textos_base['pregunta_imagen'], className='subtituloBloque'),
                    html.H5(textos_base['seleccioneFigura']),
                    getStackedBarplot(files_RIO_NEGRO_9['csv_imagen'][2], 'selectTargetRIO_NEGRO_9', 'selectOpciones_RIO_NEGRO_9',
                                      opinionColorDict, 'RIO_NEGRO_9-1D1C', opcionesDePreguntasInicial = 4), # Grafico comparado Ratio
                    html.H3('Seleccione un dirigente o funcionario político'),
                    imagen])