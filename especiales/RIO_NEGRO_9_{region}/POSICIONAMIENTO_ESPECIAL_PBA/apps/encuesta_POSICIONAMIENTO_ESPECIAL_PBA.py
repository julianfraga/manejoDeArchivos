...
path='./especiales/POSICIONAMIENTO_ESPECIAL_PBA/'
...
encuesta = Encuesta('POSICIONAMIENTO_ESPECIAL_PBA', './especiales/POSICIONAMIENTO_ESPECIAL_PBA','cuestionario', preguntas_ocultas)
