import pandas as pd
import aux
from especiales.SANTA_FE1_1.apps.paletas_SANTA_FE1_1 import paletas
from especiales.SANTA_FE1_1.apps.cuestionario_SANTA_FE1_1 import *
from especiales.SANTA_FE1_1.apps.txt_SANTA_FE1_1 import textos_SANTA_FE1_1
from especiales.SANTA_FE1_1.apps.files_SANTA_FE1_1 import files_SANTA_FE1_1
...
for pregunta, paleta in paletas.items():
    if pregunta not in preguntas_ocultas:
        cruces_dict[pregunta] = [textos_SANTA_FE1_1 ['label' + pregunta], paleta]
...
for _,row in cuestionario[~cuestionario.codigo.isin(preguntas_imagenes)].iterrows():
        ...
        if pregunta not in preguntas_ocultas:
            ...
            ps[pregunta] = aux.get_pregunta_layout(pregunta, encuesta='SANTA_FE1_1', textos=textos_SANTA_FE1_1,
                                                   files=files_SANTA_FE1_1, paletas=paletas, cruces_dict=cruces_dict,preguntas_ocultas=preguntas_ocultas,
                                                   opciones=tiene_opciones)


def dropdownTarget(id='selectTargetSANTA_FE1_1', cantidadDeOpciones=22):
    opciones = [
