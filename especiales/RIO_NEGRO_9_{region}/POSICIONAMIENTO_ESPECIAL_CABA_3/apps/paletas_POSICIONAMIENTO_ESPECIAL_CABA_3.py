...
paletas["P32"] = {'Leandro Santoro a Jefe de Gobierno por Unión por la Patria': colores["peronismo"], 'Jorge Macri a Jefe de Gobierno por Juntos por el Cambio': colores["cambiemos"], 'Ramiro Marra por la Libertad Avanza': colores["liberales"], 'Vanina Biasi por el Frente de Izquierda': colores["izquierda"], 'Otros': colores["otros"], 'En blanco': colores["blanco"], 'No sabe': colores["nosabe"]}

paletas["P33"] = {'Leandro Santoro a Jefe de Gobierno por Unión por la Patria': colores["peronismo"], 'Martin Lousteau a Jefe de Gobierno por Juntos por el Cambio': colores["cambiemos"], 'Ramiro Marra por la Libertad Avanza': colores["liberales"], 'Vanina Biasi por el Frente de Izquierda': colores["izquierda"], 'Otros': colores["otros"], 'En blanco': colores["blanco"], 'No sabe': colores["nosabe"]}
...
paletas["P41"] = {'Leandro Santoro por Unión por la Patria': colores["peronismo"], 'Jorge Macri por Juntos por el Cambio': colores["cambiemos"], 'En blanco': colores["blanco"], 'No sabe': colores["nosabe"]}

paletas["P42"] = {'Leandro Santoro por Unión por la Patria': colores["peronismo"], 'Martin Lousteau por Juntos por el Cambio': colores["cambiemos"], 'En blanco': colores["blanco"], 'No sabe': colores["nosabe"]}
