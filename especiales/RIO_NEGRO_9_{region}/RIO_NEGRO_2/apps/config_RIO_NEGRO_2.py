import pandas as pd
import aux
from especiales.RIO_NEGRO_2.apps.paletas_RIO_NEGRO_2 import paletas
from especiales.RIO_NEGRO_2.apps.cuestionario_RIO_NEGRO_2 import *
from especiales.RIO_NEGRO_2.apps.txt_RIO_NEGRO_2 import textos_RIO_NEGRO_2
from especiales.RIO_NEGRO_2.apps.files_RIO_NEGRO_2 import files_RIO_NEGRO_2
...
for pregunta, paleta in paletas.items():
    if pregunta not in preguntas_ocultas:
        cruces_dict[pregunta] = [textos_RIO_NEGRO_2 ['label' + pregunta], paleta]
...
for _,row in cuestionario[~cuestionario.codigo.isin(preguntas_imagenes)].iterrows():
        ...
        if pregunta not in preguntas_ocultas:
            ...
            ps[pregunta] = aux.get_pregunta_layout(pregunta, encuesta='RIO_NEGRO_2', textos=textos_RIO_NEGRO_2,
                                                   files=files_RIO_NEGRO_2, paletas=paletas, cruces_dict=cruces_dict,preguntas_ocultas=preguntas_ocultas,
                                                   opciones=tiene_opciones)


def dropdownTarget(id='selectTargetRIO_NEGRO_2', cantidadDeOpciones=17):
    opciones = [
...
def plot_cruces(candidato,df_cruces,files, name, preguntasQueNoVan, callbackInputTarget, crucesDict = crucesDict,opcionesDePreguntasInicial='', reorder=True):
    ...
    @app.callback(
        ...
        [Input('selectCruce' + name + candidato, 'value'),
         ...
         Input("selectOpciones_RIO_NEGRO_2", 'value'), ])
...
def plots(csv_hbp,csv_ts, csv_cruces, callbackInputTarget = '', crucesDict = crucesDict, opcionesDePreguntasInicial = 4, preguntasQueNoVan = "", preguntasDeshabilitadas = '', name = '', tracking='Nacional', files=''):
    ...
    for candidato in candidatos:
        ...
        hbarplot  = plot_hbarplot(csv_hbp, df_hbp, candidato, callbackInputTarget, 'selectOpciones_RIO_NEGRO_2', opinionColorDict, name, opcionesDePreguntasInicial = opcionesDePreguntasInicial)
...
# imagen = plots(files_RIO_NEGRO_2['csv_imagen'][0],files_RIO_NEGRO_2['csv_imagen'][3], files_RIO_NEGRO_2['Alberto Fernández'][0], callbackInputTarget= 'selectTargetRIO_NEGRO_2',opcionesDePreguntasInicial = 4,
#                           preguntasQueNoVan= preguntas_ocultas, name='RIO_NEGRO_2-Comparativo',crucesDict = cruces_dict, files=files_RIO_NEGRO_2, tracking='RIO_NEGRO_2'),
# ps['imagen1'] = html.Div([
#                html.H3(textos['pregunta_imagen'], className='subtituloBloque'),
#                html.H5(textos['seleccioneFigura']),
#                getStackedBarplot(files_RIO_NEGRO_2['csv_imagen'][0], 'selectTargetRIO_NEGRO_2', 'selectOpciones_RIO_NEGRO_2', opinionColorDict, 'RIO_NEGRO_2-1D1A', opcionesDePreguntasInicial = 4),
...
#                html.H3(textos['pregunta_imagen'], className='subtituloBloque'),
#                html.H5(textos['seleccioneFigura']),
#                getStackedBarplot(files_RIO_NEGRO_2['csv_imagen'][1], 'selectTargetRIO_NEGRO_2', 'selectOpciones_RIO_NEGRO_2', opinionColorDict, 'RIO_NEGRO_2-1D1B', opcionesDePreguntasInicial = 4),
#                html.H3('Seleccione un dirigente o funcionario político'),
#                imagen[0]])
...
#                html.H3(textos['pregunta_imagen'], className='subtituloBloque'),
#                html.H5(textos['seleccioneFigura']),
#                getStackedBarplot(files_RIO_NEGRO_2['csv_imagen'][2], 'selectTargetRIO_NEGRO_2', 'selectOpciones_RIO_NEGRO_2', opinionColorDict, 'RIO_NEGRO_2-1D1C', opcionesDePreguntasInicial = 4),
#                html.H3('Seleccione un dirigente o funcionario político'),
#                imagen[0]])
