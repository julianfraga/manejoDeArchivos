from especiales.ALQUILERES_NACIONAL_1.apps.cuestionario_ALQUILERES_NACIONAL_1 import cuestionario

textos_ALQUILERES_NACIONAL_1 ={
     'encuesta_especial': "Encuesta Nueva Ley de Alquileres",
	...
	'textoDato7': 'La captura de datos se llevó a cabo del 06/04/2023 al 07/04/2023 abarcando 3.471 casos efectivos.',
...
for _,row in cuestionario.iterrows():
	...
	textos_ALQUILERES_NACIONAL_1["pregunta" + row.codigo] = texto
	textos_ALQUILERES_NACIONAL_1["label" + row.codigo] = label
