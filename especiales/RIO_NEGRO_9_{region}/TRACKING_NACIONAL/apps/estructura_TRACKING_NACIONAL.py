...
from especiales.TRACKING_NACIONAL.apps.files_TRACKING_NACIONAL import files_TRACKING_NACIONAL
...
for _, row in encuesta.cuestionario.iterrows(): # Si quiero preguntas imaganes
    ...
    layout_preguntas[pregunta] = aux.get_pregunta_layout(pregunta, encuesta='TRACKING_NACIONAL', textos=encuesta.get_textos,
                                           files=files_TRACKING_NACIONAL, paletas=paletas, cruces_dict=cruces_dict, preguntas_ocultas=encuesta.preguntas_ocultas,
...
if encuesta.preguntas_imagenes:
    ...
    imagen = plots(files_TRACKING_NACIONAL['csv_imagen'][0],files_TRACKING_NACIONAL['csv_imagen'][3], files_TRACKING_NACIONAL["Sergio Massa"][0], callbackInputTarget= 'selectTargetTRACKING_NACIONAL',opcionesDePreguntasInicial = 4,
                                preguntasQueNoVan= encuesta.preguntas_ocultas, name='TRACKING_NACIONAL-Comparativo',crucesDict = cruces_dict, files=files_TRACKING_NACIONAL, codigo='TRACKING_NACIONAL')
    ...
    layout_preguntas['imagen1'] = html.Div([
                    ...
                    getStackedBarplot(files_TRACKING_NACIONAL['csv_imagen'][0], 'selectTargetTRACKING_NACIONAL', 'selectOpciones_TRACKING_NACIONAL',
                                      opinionColorDict, 'TRACKING_NACIONAL-1D1A', opcionesDePreguntasInicial = 4), # Grafico comparado positiva
    ...
    layout_preguntas['imagen2'] = html.Div([
                    html.H3(textos_base['pregunta_imagen'], className='subtituloBloque'),
                    html.H5(textos_base['seleccioneFigura']),
                    getStackedBarplot(files_TRACKING_NACIONAL['csv_imagen'][1], 'selectTargetTRACKING_NACIONAL', 'selectOpciones_TRACKING_NACIONAL',
                                      opinionColorDict, 'TRACKING_NACIONAL-1D1B', opcionesDePreguntasInicial = 4), # Grafico compardo Negativa
                    html.H3('Seleccione un dirigente o funcionario político'),
                    imagen])
    ...
    layout_preguntas['imagen3'] = html.Div([
                    html.H3(textos_base['pregunta_imagen'], className='subtituloBloque'),
                    html.H5(textos_base['seleccioneFigura']),
                    getStackedBarplot(files_TRACKING_NACIONAL['csv_imagen'][2], 'selectTargetTRACKING_NACIONAL', 'selectOpciones_TRACKING_NACIONAL',
                                      opinionColorDict, 'TRACKING_NACIONAL-1D1C', opcionesDePreguntasInicial = 4), # Grafico comparado Ratio
                    html.H3('Seleccione un dirigente o funcionario político'),
                    imagen])