from especiales.TRACKING_NACIONAL.apps.encuesta_TRACKING_NACIONAL import encuesta, path, opciones
...
files_TRACKING_NACIONAL['csv_imagen'] = ['{}imagen_orden_positiva.csv'.format(data_folder),
...
# { 'Sergio Massa': ['./especiales/TRACKING_NACIONAL/data/cruce_pregunta_P61_4opc.csv',
#                   './especiales/TRACKING_NACIONAL/data/cruce_pregunta_P61_6opc.csv'], ...
...
for _, row in cuestionario.query('paleta == "imagen"').iterrows():
    ...
    files_TRACKING_NACIONAL[figura] = ['{}cruce_pregunta_{}{}.csv'.format(data_folder, row.codigo, opcion)
