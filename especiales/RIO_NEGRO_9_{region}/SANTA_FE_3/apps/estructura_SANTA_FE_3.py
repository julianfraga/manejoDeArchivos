...
from especiales.SANTA_FE_3.apps.paletas_SANTA_FE_3 import paletas
from especiales.SANTA_FE_3.apps.files_SANTA_FE_3 import files_SANTA_FE_3
...
for _,row in encuesta.cuestionario[~encuesta.cuestionario.codigo.isin(encuesta.preguntas_imagenes)].iterrows():
    ...
    layout_preguntas[pregunta] = aux.get_pregunta_layout(pregunta, encuesta='SANTA_FE_3', textos=encuesta.get_textos,
                                           files=files_SANTA_FE_3, paletas=paletas, cruces_dict=cruces_dict, preguntas_ocultas=encuesta.preguntas_ocultas,
...
if encuesta.preguntas_imagenes:
    ...
    imagen = plots(files_SANTA_FE_3['csv_imagen'][0],files_SANTA_FE_3['csv_imagen'][3], files_SANTA_FE_3["Sergio Massa"][0], callbackInputTarget= 'selectTargetSANTA_FE_3',opcionesDePreguntasInicial = 4,
                                preguntasQueNoVan= encuesta.preguntas_ocultas, name='SANTA_FE_3-Comparativo',crucesDict = cruces_dict, files=files_SANTA_FE_3, codigo='SANTA_FE_3')
    ...
    layout_preguntas['imagen1'] = html.Div([
                    ...
                    getStackedBarplot(files_SANTA_FE_3['csv_imagen'][0], 'selectTargetSANTA_FE_3', 'selectOpciones_SANTA_FE_3',
                                      opinionColorDict, 'SANTA_FE_3-1D1A', opcionesDePreguntasInicial = 4), # Grafico comparado positiva
    ...
    layout_preguntas['imagen2'] = html.Div([
                    html.H3(textos_base['pregunta_imagen'], className='subtituloBloque'),
                    html.H5(textos_base['seleccioneFigura']),
                    getStackedBarplot(files_SANTA_FE_3['csv_imagen'][1], 'selectTargetSANTA_FE_3', 'selectOpciones_SANTA_FE_3',
                                      opinionColorDict, 'SANTA_FE_3-1D1B', opcionesDePreguntasInicial = 4), # Grafico compardo Negativa
                    html.H3('Seleccione un dirigente o funcionario político'),
                    imagen])
    ...
    layout_preguntas['imagen3'] = html.Div([
                    html.H3(textos_base['pregunta_imagen'], className='subtituloBloque'),
                    html.H5(textos_base['seleccioneFigura']),
                    getStackedBarplot(files_SANTA_FE_3['csv_imagen'][2], 'selectTargetSANTA_FE_3', 'selectOpciones_SANTA_FE_3',
                                      opinionColorDict, 'SANTA_FE_3-1D1C', opcionesDePreguntasInicial = 4), # Grafico comparado Ratio
                    html.H3('Seleccione un dirigente o funcionario político'),
                    imagen])