...
textos_SAN_MARTIN_2 = {
    'encuesta_especial': "Preferencias electorales. Municipio de San Martín - Junio 2023",
	'bajada_encuesta_especial': "Encuesta Sincrónica",
    'bajada_encuesta_especial_fecha': "21/06/2023",
	...
	'textoDato7': 'La captura de datos se llevó a cabo el 21/06/2023 abarcando 819 encuestas efectivas.',
...
for _,row in cuestionario.iterrows():
	...
	textos_SAN_MARTIN_2["pregunta" + row.codigo] = texto
	textos_SAN_MARTIN_2["label" + row.codigo] = label
