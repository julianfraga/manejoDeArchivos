...
path='./especiales/TRACKING_ENTRESEMANA_PROMEDIO/'
preguntas_ocultas = ['P11', 'P11_imputada', 'P11_imputada_sinblanco']
encuesta = Encuesta('TRACKING_ENTRESEMANA_PROMEDIO', './especiales/TRACKING_ENTRESEMANA_PROMEDIO','cuestionario', preguntas_ocultas)
