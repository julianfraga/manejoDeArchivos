...
path='./especiales/POSICIONAMIENTO_ESPECIAL_NACIONAL/'
preguntas_ocultas = ['P01', 'P02', 'P03', 'P04','P05', 'P07', 'P10', 'P11', 'P12', 
                     'P13', 'P14', 'P15', 'P16', 'P17', 'P19', 'P20', 'P21', 'P22', 
                     'P23', 'P24', 'P29', 'P30', 'P31', 'P32', 'P45', 'P46', 'P47', 
                     'P48', 'P49', 'P50', 'P51', 'P52']
encuesta = Encuesta('POSICIONAMIENTO_ESPECIAL_NACIONAL', './especiales/POSICIONAMIENTO_ESPECIAL_NACIONAL','cuestionario', preguntas_ocultas)
