...
from especiales.TIGRE_16.apps.paletas_TIGRE_16 import paletas
from especiales.TIGRE_16.apps.files_TIGRE_16 import files_TIGRE_16
...
for _,row in encuesta.cuestionario[~encuesta.cuestionario.codigo.isin(encuesta.preguntas_imagenes)].iterrows():
    ...
    layout_preguntas[pregunta] = aux.get_pregunta_layout(pregunta, encuesta='TIGRE_16', textos=encuesta.get_textos,
                                           files=files_TIGRE_16, paletas=paletas, cruces_dict=cruces_dict, preguntas_ocultas=encuesta.preguntas_ocultas,
...
if encuesta.preguntas_imagenes:
    ...
    imagen = plots(files_TIGRE_16['csv_imagen'][0],files_TIGRE_16['csv_imagen'][3], files_TIGRE_16["Sergio Massa"][0], callbackInputTarget= 'selectTargetTIGRE_16',opcionesDePreguntasInicial = 4,
                                preguntasQueNoVan= encuesta.preguntas_ocultas, name='TIGRE_16-Comparativo',crucesDict = cruces_dict, files=files_TIGRE_16, codigo='TIGRE_16')
    ...
    layout_preguntas['imagen1'] = html.Div([
                    ...
                    getStackedBarplot(files_TIGRE_16['csv_imagen'][0], 'selectTargetTIGRE_16', 'selectOpciones_TIGRE_16',
                                      opinionColorDict, 'TIGRE_16-1D1A', opcionesDePreguntasInicial = 4), # Grafico comparado positiva
    ...
    layout_preguntas['imagen2'] = html.Div([
                    html.H3(textos_base['pregunta_imagen'], className='subtituloBloque'),
                    html.H5(textos_base['seleccioneFigura']),
                    getStackedBarplot(files_TIGRE_16['csv_imagen'][1], 'selectTargetTIGRE_16', 'selectOpciones_TIGRE_16',
                                      opinionColorDict, 'TIGRE_16-1D1B', opcionesDePreguntasInicial = 4), # Grafico compardo Negativa
                    html.H3('Seleccione un dirigente o funcionario político'),
                    imagen])
    ...
    layout_preguntas['imagen3'] = html.Div([
                    html.H3(textos_base['pregunta_imagen'], className='subtituloBloque'),
                    html.H5(textos_base['seleccioneFigura']),
                    getStackedBarplot(files_TIGRE_16['csv_imagen'][2], 'selectTargetTIGRE_16', 'selectOpciones_TIGRE_16',
                                      opinionColorDict, 'TIGRE_16-1D1C', opcionesDePreguntasInicial = 4), # Grafico comparado Ratio
                    html.H3('Seleccione un dirigente o funcionario político'),
                    imagen])