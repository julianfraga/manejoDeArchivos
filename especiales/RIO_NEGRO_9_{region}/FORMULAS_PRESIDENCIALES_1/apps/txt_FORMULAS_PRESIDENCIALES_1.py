...
textos_FORMULAS_PRESIDENCIALES_1 ={
	'encuesta_especial': "Preferencia sobre fórmulas electorales para elecciones Presidenciales a nivel nacional. Mayo 2023",
	'bajada_encuesta_especial': "Encuesta Sincrónica",
	'bajada_encuesta_especial_fecha': "20/05/2023",
	...
	'textoDato7': 'La captura de datos se llevó a cabo del 17/05/2023 al 20/05/2023 abarcando 2.533 casos efectivos.',
...
for _,row in cuestionario.iterrows():
	...
	textos_FORMULAS_PRESIDENCIALES_1["pregunta" + row.codigo] = texto
	textos_FORMULAS_PRESIDENCIALES_1["label" + row.codigo] = label
