...
path='./especiales/POSICIONAMIENTO_ESPECIAL_NACIONAL_6/'

preguntas_ocultas = ['P13','P14','P17','P22','P25','P28','P31','P36','P37','P38','P39','P40','P41','P42','P43','P44', 'PRESIDENTE']

encuesta = Encuesta('POSICIONAMIENTO_ESPECIAL_NACIONAL_6', './especiales/POSICIONAMIENTO_ESPECIAL_NACIONAL_6','cuestionario', preguntas_ocultas)
