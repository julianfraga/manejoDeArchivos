...
from especiales.MERLO_6.apps.preguntasMERLO_6 import filesMERLO_6, preguntas, preguntas_con_opciones
import pandas as pd
...
def dropdownTargetMERLO_6(id='selectTarget', cantidadDeOpciones=10):
    opciones = opciones_MERLO_6
    return dcc.Dropdown(
...
def dropwdownOpcionesMERLO_6(id='selectOpciones_Merlo2'):
    opciones = [
...
for pregunta, paleta in paletas.items():
    ...
    crucesDictMERLO_6[pregunta] = [textosMERLO_6['label' + pregunta], paleta]
