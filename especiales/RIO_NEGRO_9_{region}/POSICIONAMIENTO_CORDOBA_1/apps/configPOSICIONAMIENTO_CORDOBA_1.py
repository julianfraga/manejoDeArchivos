...
from especiales.POSICIONAMIENTO_CORDOBA_1.apps.preguntasPOSICIONAMIENTO_CORDOBA_1 import filesPOSICIONAMIENTO_CORDOBA_1, preguntas, preguntas_con_opciones
import pandas as pd


opciones_POSICIONAMIENTO_CORDOBA_1 = [
...
def dropdownTargetPOSICIONAMIENTO_CORDOBA_1(id='selectTarget', cantidadDeOpciones=20):
    opciones = opciones_POSICIONAMIENTO_CORDOBA_1
    return dcc.Dropdown(
...
def dropwdownOpcionesPOSICIONAMIENTO_CORDOBA_1(id='selectOpciones'):
    opciones = [
...
preguntas_CABA_1 = ['P07', 'P08', 'P09', 'P10', 'P11', 'P12', 'P13', 'P15', 'P17', 'P18', 'P19', 'P20', 'P21', 'P22', 'P23', 'P24',
                    #'P42', 'P44', 'P46', 'P47', 'P48', 'P49', 'P50', 'P51', 'P52'
                    ]
...
crucesDictPOSICIONAMIENTO_CORDOBA_1 = {}
for pregunta, paleta in paletas.items():

    crucesDictPOSICIONAMIENTO_CORDOBA_1[pregunta] = [textosPOSICIONAMIENTO_CORDOBA_1['label' + pregunta], paleta]
