from especiales.POSICIONAMIENTO_CORDOBA_1.apps.preguntasPOSICIONAMIENTO_CORDOBA_1 import filesPOSICIONAMIENTO_CORDOBA_1, preguntasQueNoVanPOSICIONAMIENTO_CORDOBA_1
...
from especiales.POSICIONAMIENTO_CORDOBA_1.apps.bloquesPOSICIONAMIENTO_CORDOBA_1 import bloques_POSICIONAMIENTO_CORDOBA_1
from graphs import *
from especiales.POSICIONAMIENTO_CORDOBA_1.apps.txtPOSICIONAMIENTO_CORDOBA_1 import textosPOSICIONAMIENTO_CORDOBA_1 as textos
from permisos import trackingSANTIAGOPreguntasDeshabilitadas
from graph_imagen import plots
from especiales.POSICIONAMIENTO_CORDOBA_1.apps.preguntasPOSICIONAMIENTO_CORDOBA_1 import imagenes

preguntas = {}
for bloque in bloques_POSICIONAMIENTO_CORDOBA_1.values():
    for pregunta in bloque:
        preguntas[pregunta] = textosPOSICIONAMIENTO_CORDOBA_1["label" + pregunta]

orden_preguntas = []
for _ in bloques_POSICIONAMIENTO_CORDOBA_1.values():
...
for p in preguntas_CABA_1:
    ps[p] = html.Div([
        html.H3(textosPOSICIONAMIENTO_CORDOBA_1['pregunta' + p], className='subtituloBloque'),
        getBarplotWithPalette(filesPOSICIONAMIENTO_CORDOBA_1['csv' + p][0], 'selectTargetPOSICIONAMIENTO_CORDOBA_1',
                              paletas[p], f'POSICIONAMIENTO_CORDOBA_1-{p}-1', showticklabels=False, reverse=False),

        html.H3(textosPOSICIONAMIENTO_CORDOBA_1['cruce'], className='subtituloBloque'),
        getCrucesStacked(filesPOSICIONAMIENTO_CORDOBA_1['csv' + p ][2], f'POSICIONAMIENTO_CORDOBA_1-{p}-3',
                         'selectTargetPOSICIONAMIENTO_CORDOBA_1', '',
                         preguntasQueNoVan=preguntasQueNoVanPOSICIONAMIENTO_CORDOBA_1, reorder=False,
                         crucesDict=crucesDictPOSICIONAMIENTO_CORDOBA_1)
    ])
...
imagen = plots(filesPOSICIONAMIENTO_CORDOBA_1['csv_imagen'][0],filesPOSICIONAMIENTO_CORDOBA_1['csv_imagen'][3], filesPOSICIONAMIENTO_CORDOBA_1["Alberto Fernandez"][0], callbackInputTarget= 'selectTargetPOSICIONAMIENTO_CORDOBA_1',opcionesDePreguntasInicial = 4,
                            preguntasQueNoVan= preguntasQueNoVanPOSICIONAMIENTO_CORDOBA_1, name='POSICIONAMIENTO_CORDOBA_1-Comparativo',crucesDict = crucesDictPOSICIONAMIENTO_CORDOBA_1, files=filesPOSICIONAMIENTO_CORDOBA_1, tracking='POSICIONAMIENTO_CORDOBA_1'),



ps['imagen1'] = html.Div([
                html.H3(textosPOSICIONAMIENTO_CORDOBA_1['pregunta_imagen'], className='subtituloBloque'),
                html.H5(textosPOSICIONAMIENTO_CORDOBA_1['seleccioneFigura']),
                getStackedBarplot(filesPOSICIONAMIENTO_CORDOBA_1['csv_imagen'][0], 'selectTargetPOSICIONAMIENTO_CORDOBA_1', 'selectOpciones', opinionColorDict, 'POSICIONAMIENTO_CORDOBA_1-1D1A', opcionesDePreguntasInicial = 4),
...
ps['imagen2'] = html.Div([
                html.H3(textosPOSICIONAMIENTO_CORDOBA_1['pregunta_imagen'], className='subtituloBloque'),
                html.H5(textosPOSICIONAMIENTO_CORDOBA_1['seleccioneFigura']),
                getStackedBarplot(filesPOSICIONAMIENTO_CORDOBA_1['csv_imagen'][1], 'selectTargetPOSICIONAMIENTO_CORDOBA_1', 'selectOpciones', opinionColorDict, 'POSICIONAMIENTO_CORDOBA_1-1D1B', opcionesDePreguntasInicial = 4),
                html.H3('Seleccione un dirigente o funcionario político'),
                imagen[0]])
...
ps['imagen3'] = html.Div([
                html.H3(textosPOSICIONAMIENTO_CORDOBA_1['pregunta_imagen'], className='subtituloBloque'),
                html.H5(textosPOSICIONAMIENTO_CORDOBA_1['seleccioneFigura']),
                getStackedBarplot(filesPOSICIONAMIENTO_CORDOBA_1['csv_imagen'][2], 'selectTargetPOSICIONAMIENTO_CORDOBA_1', 'selectOpciones', opinionColorDict, 'POSICIONAMIENTO_CORDOBA_1-1D1C', opcionesDePreguntasInicial = 4),
                html.H3('Seleccione un dirigente o funcionario político'),
                imagen[0]])
