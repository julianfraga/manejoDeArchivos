...
path='./especiales/TRACKING_PBA_E/'
preguntas_ocultas = ['P13', 'P13_imputada', 'P16', 'P17']
encuesta = Encuesta('TRACKING_PBA_E', './especiales/TRACKING_PBA_E','cuestionario', preguntas_ocultas)
