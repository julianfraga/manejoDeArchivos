from especiales.SANTA_FE_1.apps.cuestionario_SANTA_FE_1 import cuestionario

textos_SANTA_FE_1 = {
    'encuesta_especial': "Preferencias electorales: Elecciones generales Santa Fé 2023 - Julio 2023",
	...
	'tituloDato3': 'Ámbito',
	'textoDato3': 'Provincia de Santa Fé',
	...
	'textoDato6': 'Muestreo aleatorio estratificado por cuatro zonas geográficas: Ciudad de Rosario, Ciudad de Santa Fé, interior Norte e interior Sur. La probabilidad de selección hacia el interior de cada estrato se definió de manera proporcional al tamaño del agrupamiento.',
	'tituloDato7': 'Tamaño muestral',
	'textoDato7': 'La captura de datos se llevó a cabo del 03/07/2023 al 05/07/2023 abarcando 1.920 casos efectivos.',
...
for _,row in cuestionario.iterrows():
	...
	textos_SANTA_FE_1["pregunta" + row.codigo] = texto
	textos_SANTA_FE_1["label" + row.codigo] = label
