...
textos_MENDOZA_1 = {
    'encuesta_especial': "Encuesta Electoral Mendoza - Junio 2023",
	'bajada_encuesta_especial': "Encuesta Sincrónica",
    'bajada_encuesta_especial_fecha': "03/06/2023",
	...
	'tituloDato3': 'Ámbito',
	'textoDato3': 'Provincia de Mendoza',
	...
	'textoDato7': 'La captura de datos se llevó a cabo del 31/05/2023 al 03/05/2023 abarcando 1676 casos efectivos.',
	...
	'bloque1': 'Bloque Escenarios Políticos',
	'bloque1href': '/apps/bloque1',
	'bloque2': 'Reach de candidatos a Gobernador y Vice',
	'bloque2href': '/apps/bloque2',
	'bloque3': 'Bloque Imagen de dirigentes',
...
for _,row in cuestionario.iterrows():
	...
	textos_MENDOZA_1["pregunta" + row.codigo] = texto
	textos_MENDOZA_1["label" + row.codigo] = label
