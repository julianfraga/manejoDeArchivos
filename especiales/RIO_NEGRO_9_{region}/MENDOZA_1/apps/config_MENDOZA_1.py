import pandas as pd
import aux
from especiales.MENDOZA_1.apps.paletas_MENDOZA_1 import paletas
from especiales.MENDOZA_1.apps.cuestionario_MENDOZA_1 import *
from especiales.MENDOZA_1.apps.txt_MENDOZA_1 import textos_MENDOZA_1
from especiales.MENDOZA_1.apps.files_MENDOZA_1 import files_MENDOZA_1
...
ps = {}
preguntas_ocultas = ['P56']

cruces_dict = {}
for pregunta, paleta in paletas.items():
    if pregunta not in preguntas_ocultas:
        cruces_dict[pregunta] = [textos_MENDOZA_1 ['label' + pregunta], paleta]
...
for _,row in cuestionario[~cuestionario.codigo.isin(preguntas_imagenes)].iterrows():
        ...
        if pregunta not in preguntas_ocultas:
            ...
            ps[pregunta] = aux.get_pregunta_layout(pregunta, encuesta='MENDOZA_1', textos=textos_MENDOZA_1,
                                                   files=files_MENDOZA_1, paletas=paletas, cruces_dict=cruces_dict,preguntas_ocultas=preguntas_ocultas,
                                                   opciones=tiene_opciones)


def dropdownTarget(id='selectTargetMENDOZA_1', cantidadDeOpciones=17):
    opciones = [
        ...
        # {'label': 'placeholder', 'value': '654'},
        # {'label': 'placeholder', 'value': '655A'},
        # {'label': 'placeholder', 'value': '653'},
        # {'label': 'placeholder', 'value': '652A'},
        # {'label': 'placeholder', 'value': '655'},
        # {'label': 'placeholder', 'value': '652'},
        ...
        {'label': 'Voto gobernador 2019: R. Suárez y M. Abed', 'value': 'Suarez/Abed'},
        {'label': 'Voto gobernador 2019: A. Fernández Sagasti y J. Tanus', 'value': 'Fernández Sagasti/Tanus'},
        {'label': 'Voto gobernador 2019: J. L. Ramón y M. Vadillo', 'value': 'Ramón/Vadillo'},
        {'label': 'Voto gobernador 2019: N. Barbeito y S. Sosa', 'value': 'Barbeito/Sosa'},
        ]
...
def plot_cruces(candidato,df_cruces,files, name, preguntasQueNoVan, callbackInputTarget, crucesDict = crucesDict,opcionesDePreguntasInicial='', reorder=True):
    ...
    @app.callback(
        ...
        [Input('selectCruce' + name + candidato, 'value'),
         ...
         Input("selectOpciones_MENDOZA_1", 'value'), ])
...
def plots(csv_hbp,csv_ts, csv_cruces, callbackInputTarget = '', crucesDict = crucesDict, opcionesDePreguntasInicial = 4, preguntasQueNoVan = "", preguntasDeshabilitadas = '', name = '', tracking='Nacional', files=''):
    ...
    for candidato in candidatos:
        ...
        hbarplot  = plot_hbarplot(csv_hbp, df_hbp, candidato, callbackInputTarget, 'selectOpciones_MENDOZA_1', opinionColorDict, name, opcionesDePreguntasInicial = opcionesDePreguntasInicial)
...
imagen = plots(files_MENDOZA_1['csv_imagen'][0],files_MENDOZA_1['csv_imagen'][3], files_MENDOZA_1['Alfredo Cornejo'][0], callbackInputTarget= 'selectTargetMENDOZA_1',opcionesDePreguntasInicial = 4,
                          preguntasQueNoVan= preguntas_ocultas, name='MENDOZA_1-Comparativo',crucesDict = cruces_dict, files=files_MENDOZA_1, tracking='MENDOZA_1'),
ps['imagen1'] = html.Div([
               html.H3(textos['pregunta_imagen'], className='subtituloBloque'),
               html.H5(textos['seleccioneFigura']),
               getStackedBarplot(files_MENDOZA_1['csv_imagen'][0], 'selectTargetMENDOZA_1', 'selectOpciones_MENDOZA_1', opinionColorDict, 'MENDOZA_1-1D1A', opcionesDePreguntasInicial = 4),
...
ps['imagen2'] = html.Div([
               html.H3(textos['pregunta_imagen'], className='subtituloBloque'),
               html.H5(textos['seleccioneFigura']),
               getStackedBarplot(files_MENDOZA_1['csv_imagen'][1], 'selectTargetMENDOZA_1', 'selectOpciones_MENDOZA_1', opinionColorDict, 'MENDOZA_1-1D1B', opcionesDePreguntasInicial = 4),
               html.H3('Seleccione un dirigente o funcionario político'),
               imagen[0]])
...
ps['imagen3'] = html.Div([
               html.H3(textos['pregunta_imagen'], className='subtituloBloque'),
               html.H5(textos['seleccioneFigura']),
               getStackedBarplot(files_MENDOZA_1['csv_imagen'][2], 'selectTargetMENDOZA_1', 'selectOpciones_MENDOZA_1', opinionColorDict, 'MENDOZA_1-1D1C', opcionesDePreguntasInicial = 4),
               html.H3('Seleccione un dirigente o funcionario político'),
               imagen[0]])
