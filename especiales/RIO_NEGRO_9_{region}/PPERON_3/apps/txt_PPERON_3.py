...
textos_PPERON_3 = {
	'encuesta_especial': "Encuesta Electoral Partido de Presidente Perón - Junio 2023",
	'bajada_encuesta_especial': "Encuesta Sincrónica",
    'bajada_encuesta_especial_fecha': "16/06/2023",
    ...
    'textoDato2': 'Teléfonos celulares de la de las empresas Personal, Movistar y Claro complementados con un 13% de teléfonos fijos para optimizar cobertura geográfica',
	'tituloDato3': 'Ámbito',
	'textoDato3': 'Partido de Presidente Perón',
	...
	'textoDato7': 'La captura de datos se llevó a cabo del 14/06/2023 al 16/06/2023 abarcando 445 encuestas efectivas',
	...
	'bloque1': 'Bloque Sociodemográfico',
	'bloque1href': '/apps/bloque1',
	'bloque2': 'Bloque General',
	'bloque2href': '/apps/bloque1',
	'bloque3': 'Bloque Reach de intención de voto',
	'bloque3href': '/apps/bloque2',
...
for _,row in cuestionario.iterrows():
	...
	textos_PPERON_3["pregunta" + row.codigo] = texto
	textos_PPERON_3["label" + row.codigo] = label
