...
path='./especiales/MISIONES_1/'
preguntas_ocultas = []
encuesta = Encuesta('MISIONES_1', './especiales/MISIONES_1','cuestionario', preguntas_ocultas)
...
opciones_target = [
        ...
        {'label' : 'Voto Gobernador PASO: H. Passalacqua', 'value' : 'Passalacqua'},
        {'label' : 'Voto Gobernador PASO: M. Ariol', 'value' : 'Ariol'},
        {'label' : 'Voto Gobernador PASO: P. Lenguaza', 'value' : 'Lenguaza'},
        {'label' : 'Voto Gobernador PASO: J. Perie', 'value' : 'Perie'},
        {'label' : 'Voto Gobernador PASO: L. Villanueva', 'value' : 'Villanueva'},
        {'label': 'Región: Posadas', 'value': 'Posadas'},
