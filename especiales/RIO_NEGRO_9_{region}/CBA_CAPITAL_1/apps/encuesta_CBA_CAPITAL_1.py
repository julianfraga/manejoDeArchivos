...
encuesta = Encuesta('CBA_CAPITAL_1', './especiales/CBA_CAPITAL_1','cuestionario', preguntas_ocultas)
...
opciones_target = [
        ...
        {'label': 'Voto Intendente 2019: M. Llaryora', 'value': 'Llaryora'},
        {'label': 'Voto Intendente 2019: L. Juez', 'value': 'Juez'},
        {'label': 'Voto Intendente 2019: A. Garcia Elorrio', 'value': 'Garcia Elorrio'},
        {'label': 'Voto Intendente 2019: A. Spaccesi', 'value': 'Spaccesi'},
        {'label': 'Voto Intendente 2019: L. Olivero', 'value': 'Olivero'},
        ]
