...
path='./especiales/RIO_NEGRO_8/'
preguntas_ocultas = []
encuesta = Encuesta('RIO_NEGRO_8', './especiales/RIO_NEGRO_8','cuestionario', preguntas_ocultas)
...
opciones_target = [
        ...
        {'label': 'Región: Otras Localidades', 'value': 'Resto'},
