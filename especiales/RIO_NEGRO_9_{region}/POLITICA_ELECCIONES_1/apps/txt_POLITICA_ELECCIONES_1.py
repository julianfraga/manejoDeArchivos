...
textos_POLITICA_ELECCIONES_1 ={
	'encuesta_especial': "Política, elecciones y participación ciudadana. Mayo 2023",
	'bajada_encuesta_especial': "Encuesta Sincrónica",
	'bajada_encuesta_especial_fecha': "23/05/2023",
	...
	'textoDato7': 'La captura de datos se llevó a cabo del 19/05/2023 al 23/05/2023 abarcando 1.485 casos efectivos.',
...
for _,row in cuestionario.iterrows():
	...
	textos_POLITICA_ELECCIONES_1["pregunta" + row.codigo] = texto
	textos_POLITICA_ELECCIONES_1["label" + row.codigo] = label
