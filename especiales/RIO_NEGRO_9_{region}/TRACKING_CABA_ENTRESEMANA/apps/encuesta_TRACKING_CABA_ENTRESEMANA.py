...
path='./especiales/TRACKING_CABA_ENTRESEMANA/'
preguntas_ocultas = []
encuesta = Encuesta('TRACKING_CABA_ENTRESEMANA', './especiales/TRACKING_CABA_ENTRESEMANA','cuestionario', preguntas_ocultas)
