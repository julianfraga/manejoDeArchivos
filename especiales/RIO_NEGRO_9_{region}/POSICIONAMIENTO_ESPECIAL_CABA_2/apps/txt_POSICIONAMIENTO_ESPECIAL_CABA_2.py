...
textos_POSICIONAMIENTO_ESPECIAL_CABA_2 ={
	'encuesta_especial': "Posicionamiento politico y preferencias electorales. Elecciones a Jefe de Gobierno. Julio 2023",
	...
	'textoDato7': 'La captura de datos se llevó a cabo del 13/07/2023 al 14/07/2023 abarcando 1.254 encuestas efectivas.',
...
for _,row in cuestionario.iterrows():
	...
	textos_POSICIONAMIENTO_ESPECIAL_CABA_2["pregunta" + row.codigo] = texto
	textos_POSICIONAMIENTO_ESPECIAL_CABA_2["label" + row.codigo] = label
