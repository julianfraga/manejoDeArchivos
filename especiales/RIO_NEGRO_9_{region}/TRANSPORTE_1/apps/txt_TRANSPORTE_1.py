...
textos_TRANSPORTE_1 = {
    'encuesta_especial': "Transporte público: frecuencia de utilización y experiencia de usuario - \n Junio 2023",
	'bajada_encuesta_especial': "Encuesta Sincrónica",
    'bajada_encuesta_especial_fecha': "08/06/2023",
	...
	'textoDato7': 'La captura de datos se llevó a cabo del 06/06/2023 al 08/06/2023 abarcando 3854 encuestas efectivas.',
...
for _,row in cuestionario.iterrows():
	...
	textos_TRANSPORTE_1["pregunta" + row.codigo] = texto
	textos_TRANSPORTE_1["label" + row.codigo] = label
