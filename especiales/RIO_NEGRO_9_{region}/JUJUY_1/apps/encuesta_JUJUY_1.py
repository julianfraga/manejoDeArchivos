...
path='./especiales/JUJUY_1/'
preguntas_ocultas = []
encuesta = Encuesta('JUJUY_1', './especiales/JUJUY_1','cuestionario', preguntas_ocultas)
...
opciones_target = [
        ...
        {'label': 'Región: San Salvador de Jujuy', 'value': 'San Salvador de Jujuy'},
