...
from especiales.PPERON_1.apps.preguntasPPERON_1 import filesPPERON_1, preguntas, preguntas_con_opciones
import pandas as pd


def dropdownTargetPPERON_1(id='selectTargetPPERON_1', cantidadDeOpciones=13):
...
def dropwdownOpcionesPPERON_1(id='selectOpciones'):
    opciones = [
...
paletas['P05'] ={
    "Victoria Tolosa Paz para diputada nacional y Walter Enrique Acuña para concejal por el “Frente de todos”": colores["peron1"],
...
for pregunta, paleta in paletas.items():
    ...
    crucesDictPPERON_1[pregunta] = [textosPPERON_1['label' + pregunta], paleta]
