...
textos_INSEGURIDAD = {
    'encuesta_especial': "Percepción y vivencia de la inseguridad. \n  Encuesta Nacional - Junio 2023",
	'bajada_encuesta_especial': "Encuesta Sincrónica",
    'bajada_encuesta_especial_fecha': "22/06/2023",
	...
	'textoDato7': 'La captura de datos se llevó a cabo del 21/06/2023 al 22/06/2023 abarcando 3872 casos efectivos.',
	...
	'bloque2': 'Bloque Delitos a la propiedad',
	'bloque2href': '/apps/bloque2',
	'bloque3': 'Bloque Delitos en la vía pública',
	'bloque3href': '/apps/bloque3',
	'bloque4': 'Bloque Políticas públicas de seguridad',
	'bloque4href': '/apps/bloque4',
	'bloque5': 'Bloque Hábitos de compra y planificación de comidas',
...
for _,row in cuestionario.iterrows():
	...
	textos_INSEGURIDAD["pregunta" + row.codigo] = texto
	textos_INSEGURIDAD["label" + row.codigo] = label
