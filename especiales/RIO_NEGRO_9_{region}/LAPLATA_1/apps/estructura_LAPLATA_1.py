...
from especiales.LAPLATA_1.apps.paletas_LAPLATA_1 import paletas
from especiales.LAPLATA_1.apps.files_LAPLATA_1 import files_LAPLATA_1
...
for _,row in encuesta.cuestionario[~encuesta.cuestionario.codigo.isin(encuesta.preguntas_imagenes)].iterrows():
    ...
    layout_preguntas[pregunta] = aux.get_pregunta_layout(pregunta, encuesta='LAPLATA_1', textos=encuesta.get_textos,
                                           files=files_LAPLATA_1, paletas=paletas, cruces_dict=cruces_dict, preguntas_ocultas=encuesta.preguntas_ocultas,
...
if encuesta.preguntas_imagenes:
    ...
    imagen = plots(files_LAPLATA_1['csv_imagen'][0],files_LAPLATA_1['csv_imagen'][3], files_LAPLATA_1["Sergio Massa"][0], callbackInputTarget= 'selectTargetLAPLATA_1',opcionesDePreguntasInicial = 4,
                                preguntasQueNoVan= encuesta.preguntas_ocultas, name='LAPLATA_1-Comparativo',crucesDict = cruces_dict, files=files_LAPLATA_1, codigo='LAPLATA_1')
    ...
    layout_preguntas['imagen1'] = html.Div([
                    ...
                    getStackedBarplot(files_LAPLATA_1['csv_imagen'][0], 'selectTargetLAPLATA_1', 'selectOpciones_LAPLATA_1',
                                      opinionColorDict, 'LAPLATA_1-1D1A', opcionesDePreguntasInicial = 4), # Grafico comparado positiva
    ...
    layout_preguntas['imagen2'] = html.Div([
                    html.H3(textos_base['pregunta_imagen'], className='subtituloBloque'),
                    html.H5(textos_base['seleccioneFigura']),
                    getStackedBarplot(files_LAPLATA_1['csv_imagen'][1], 'selectTargetLAPLATA_1', 'selectOpciones_LAPLATA_1',
                                      opinionColorDict, 'LAPLATA_1-1D1B', opcionesDePreguntasInicial = 4), # Grafico compardo Negativa
                    html.H3('Seleccione un dirigente o funcionario político'),
                    imagen])
    ...
    layout_preguntas['imagen3'] = html.Div([
                    html.H3(textos_base['pregunta_imagen'], className='subtituloBloque'),
                    html.H5(textos_base['seleccioneFigura']),
                    getStackedBarplot(files_LAPLATA_1['csv_imagen'][2], 'selectTargetLAPLATA_1', 'selectOpciones_LAPLATA_1',
                                      opinionColorDict, 'LAPLATA_1-1D1C', opcionesDePreguntasInicial = 4), # Grafico comparado Ratio
                    html.H3('Seleccione un dirigente o funcionario político'),
                    imagen])