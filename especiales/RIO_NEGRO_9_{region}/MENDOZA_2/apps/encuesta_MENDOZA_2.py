...
path='./especiales/MENDOZA_2/'
preguntas_ocultas = []
encuesta = Encuesta('MENDOZA_2', './especiales/MENDOZA_2','cuestionario', preguntas_ocultas)
...
opciones_target = [
        ...
        {'label' : 'Voto Gobernador PASO 2023: A. Cornejo', 'value' : 'Cornejo'},
        {'label' : 'Voto Gobernador PASO 2023: L. Petri', 'value' : 'Petri'},
        {'label' : 'Voto Gobernador PASO 2023: O. De Marchi', 'value' : 'De Marchi'},
        {'label' : 'Voto Gobernador PASO 2023: O. Parisi', 'value' : 'Parisi'},
        {'label' : 'Voto Gobernador PASO 2023: G. Carmona', 'value' : 'Carmona'},
        {'label' : 'Voto Gobernador PASO 2023: N. Guillén', 'value' : 'Guillén'},
                                     ]
