from especiales.TIGRE_3.apps.preguntasTIGRE_3 import filesTIGRE_3, preguntasQueNoVanTIGRE_3
...
from especiales.TIGRE_3.apps.txtTIGRE_3 import textosTIGRE_3
from config import *
from especiales.TIGRE_3.apps.configTIGRE_3 import *
from especiales.TIGRE_3.apps.bloquesTIGRE_3 import bloques_TIGRE_3
from graphs import *
from especiales.TIGRE_3.apps.txtTIGRE_3 import textosTIGRE_3 as textos
from permisos import trackingSANTIAGOPreguntasDeshabilitadas
from graph_imagen import plots

preguntas = {}
for bloque in bloques_TIGRE_3.values():
    for pregunta in bloque:
        preguntas[pregunta] = textosTIGRE_3["label" + pregunta]

orden_preguntas = []
for _ in bloques_TIGRE_3.values():
...
ps['P06'] = html.Div([
        html.H3(textosTIGRE_3['preguntaP06'], className='subtituloBloque'),
        getBarplotWithPalette(filesTIGRE_3['csvP06'][0], 'selectTargetTIGRE_3', paletas['P06'], 'TIGRE_3-P06-1', showticklabels=False, reverse=False),
        #html.H3(),
        #getTimeSeriesLineplot(filesTIGRE_3['csvP06'][1], TIGRE_3P06, 'TIGRE_3-P06-2', 'selectTargetTIGRE_3', opcionesDePreguntasInicial=3),
        html.H3(textosTIGRE_3['cruce'], className='subtituloBloque'),
        getCrucesStacked(filesTIGRE_3['csvP06'][2], 'TIGRE_3-P06-3', 'selectTargetTIGRE_3', '', preguntasQueNoVan = preguntasQueNoVanTIGRE_3, crucesDict = crucesDictTIGRE_3, reorder=False)
])

ps['P08'] = html.Div([
        html.H3(textosTIGRE_3['preguntaP08'], className='subtituloBloque'),
        getBarplotWithPalette(filesTIGRE_3['csvP08'][0], 'selectTargetTIGRE_3', paletas['P08'], 'TIGRE_3-P08-1', showticklabels=False, reverse=False),
        #html.H3(),
        #getTimeSeriesLineplot(filesTIGRE_3['csvP08'][1], TIGRE_3P08, 'TIGRE_3-P08-2', 'selectTargetTIGRE_3', opcionesDePreguntasInicial=3),
        html.H3(textosTIGRE_3['cruce'], className='subtituloBloque'),
        getCrucesStacked(filesTIGRE_3['csvP08'][2], 'TIGRE_3-P08-3', 'selectTargetTIGRE_3', '', preguntasQueNoVan = preguntasQueNoVanTIGRE_3, crucesDict = crucesDictTIGRE_3, reorder=False)
])


# ps['P10'] = html.Div([
#         html.H3(textosTIGRE_3['preguntaP10'], className='subtituloBloque'),
#         getBarplotWithPalette(filesTIGRE_3['csvP10'][0], 'selectTargetTIGRE_3', paletas['P10'], 'TIGRE_3-P10-1', showticklabels=False, reverse=False),
#         #html.H3(),
#         #getTimeSeriesLineplot(filesTIGRE_3['csvP10'][1], TIGRE_3P10, 'TIGRE_3-P10-2', 'selectTargetTIGRE_3', opcionesDePreguntasInicial=3),
#         html.H3(textosTIGRE_3['cruce'], className='subtituloBloque'),
#         getCrucesStacked(filesTIGRE_3['csvP10'][2], 'TIGRE_3-P10-3', 'selectTargetTIGRE_3', '', preguntasQueNoVan = preguntasQueNoVanTIGRE_3, crucesDict = crucesDictTIGRE_3, reorder=False)
# ])

# ps['P12'] = html.Div([
#         html.H3(textosTIGRE_3['preguntaP12'], className='subtituloBloque'),
#         getBarplotWithPalette(filesTIGRE_3['csvP12'][0], 'selectTargetTIGRE_3', paletas['P12'], 'TIGRE_3-P12-1', showticklabels=False, reverse=False),
#         #html.H3(),
#         #getTimeSeriesLineplot(filesTIGRE_3['csvP12'][1], TIGRE_3P12, 'TIGRE_3-P12-2', 'selectTargetTIGRE_3', opcionesDePreguntasInicial=3),
#         html.H3(textosTIGRE_3['cruce'], className='subtituloBloque'),
#         getCrucesStacked(filesTIGRE_3['csvP12'][2], 'TIGRE_3-P12-3', 'selectTargetTIGRE_3', '', preguntasQueNoVan = preguntasQueNoVanTIGRE_3, crucesDict = crucesDictTIGRE_3, reorder=False)
# ])


ps['P14'] = html.Div([
        html.H3(textosTIGRE_3['preguntaP14'], className='subtituloBloque'),
        getBarplotWithPalette(filesTIGRE_3['csvP14'][0], 'selectTargetTIGRE_3', paletas['P14'], 'TIGRE_3-P14-1', showticklabels=False, reverse=False),
        #html.H3(),
        #getTimeSeriesLineplot(filesTIGRE_3['csvP14'][1], TIGRE_3P14, 'TIGRE_3-P14-2', 'selectTargetTIGRE_3', opcionesDePreguntasInicial=3),
        html.H3(textosTIGRE_3['cruce'], className='subtituloBloque'),
        getCrucesStacked(filesTIGRE_3['csvP14'][2], 'TIGRE_3-P14-3', 'selectTargetTIGRE_3', '', preguntasQueNoVan = preguntasQueNoVanTIGRE_3, crucesDict = crucesDictTIGRE_3, reorder=False)
])
...
# Modelo
# ps['PXX'] = html.Div([
#         html.H3(textosTIGRE_3['preguntaPXX'], className='subtituloBloque'),
#         getBarplotWithPalette(filesTIGRE_3['csvPXX'][0], 'selectTargetTIGRE_3', paletas['PXX'], 'TIGRE_3-PXX-1', showticklabels=False, reverse=False),
#         #html.H3(),
#         #getTimeSeriesLineplot(filesTIGRE_3['csvPXX'][1], TIGRE_3PXX, 'TIGRE_3-PXX-2', 'selectTargetTIGRE_3', opcionesDePreguntasInicial=3),
#         html.H3(textosTIGRE_3['cruce'], className='subtituloBloque'),
#         getCrucesStacked(filesTIGRE_3['csvPXX'][2], 'TIGRE_3-PXX-3', 'selectTargetTIGRE_3', '', preguntasQueNoVan = preguntasQueNoVanTIGRE_3, crucesDict = crucesDictTIGRE_3)
# ])
...
imagen = plots(filesTIGRE_3['csv_imagen'][0],filesTIGRE_3['csv_imagen'][3], filesTIGRE_3['Alberto Fernandez'][0], callbackInputTarget= 'selectTargetTIGRE_3',opcionesDePreguntasInicial = 3,
                            preguntasQueNoVan= preguntasQueNoVanTIGRE_3, name='TIGRE_3-Comparativo',crucesDict = crucesDictTIGRE_3, files=filesTIGRE_3, tracking='TIGRE_3'),



ps['imagen1'] = html.Div([
                html.H3(textosTIGRE_3['pregunta_imagen'], className='subtituloBloque'),
                html.H5(textosTIGRE_3['seleccioneFigura']),
                getStackedBarplot(filesTIGRE_3['csv_imagen'][0], 'selectTargetTIGRE_3', 'selectOpciones', opinionColorDict, 'TIGRE_3-1D1A', opcionesDePreguntasInicial = 3),
...
ps['imagen2'] = html.Div([
                html.H3(textosTIGRE_3['pregunta_imagen'], className='subtituloBloque'),
                html.H5(textosTIGRE_3['seleccioneFigura']),
                getStackedBarplot(filesTIGRE_3['csv_imagen'][1], 'selectTargetTIGRE_3', 'selectOpciones', opinionColorDict, 'TIGRE_3-1D1B', opcionesDePreguntasInicial = 3),
                html.H3('Seleccione un dirigente o funcionario político'),
                imagen[0]])
...
ps['imagen3'] = html.Div([
                html.H3(textosTIGRE_3['pregunta_imagen'], className='subtituloBloque'),
                html.H5(textosTIGRE_3['seleccioneFigura']),
                getStackedBarplot(filesTIGRE_3['csv_imagen'][2], 'selectTargetTIGRE_3', 'selectOpciones', opinionColorDict, 'TIGRE_3-1D1C', opcionesDePreguntasInicial = 3),
                html.H3('Seleccione un dirigente o funcionario político'),
                imagen[0]])
