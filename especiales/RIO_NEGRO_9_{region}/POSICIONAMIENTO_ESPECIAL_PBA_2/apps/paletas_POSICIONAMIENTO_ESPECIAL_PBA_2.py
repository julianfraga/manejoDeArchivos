from especiales.POSICIONAMIENTO_ESPECIAL_PBA_2.apps.cuestionario_POSICIONAMIENTO_ESPECIAL_PBA_2 import cuestionario
...
paletas["P35"] = {'Sergio Massa a Presidente y Agustin Rossi a Vicepresidente por Unión por la Patria': colores["peronismo"], 'Horacio Rodríguez Larreta  a Presidente y Gerardo Morales a Vicepresidente por Juntos por el Cambio': colores["cambiemos"], 'En blanco': colores["blanco"], 'No sabe': colores["nosabe"]}
...
paletas["P37"] = {'Sergio Massa a Presidente y Agustin Rossi a Vicepresidente por Unión por la Patria': colores["peronismo"], 'Javier Milei a Presidente y Victoria Villarruel a Vicepresidente por La Libertad Avanza': colores["liberales"], 'En blanco': colores["blanco"], 'No sabe': colores["nosabe"]}

paletas["P38"] = {'Leandro Santoro por Unión por la Patria': colores["peronismo"], 'Jorge Macri por Juntos por el Cambio': colores["cambiemos"], 'En blanco': colores["blanco"], 'No sabe': colores["nosabe"]}

paletas["P39"] = {'Leandro Santoro por Unión por la Patria': colores["peronismo"], 'Martin Lousteau por Juntos por el Cambio': colores["cambiemos"], 'En blanco': colores["blanco"], 'No sabe': colores["nosabe"]}
